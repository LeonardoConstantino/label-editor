...
`;var Se=new Set,Ce=class extends HTMLElement{#e;#t;#n;#r=null;static observedAttributes=[`name`,`size`,`color`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(xe.content.cloneNode(!0)),this.#t=this.#e.getElementById(`icon-container`),this.#n=this.#e.querySelector(`slot`)}connectedCallback(){this.#r=new AbortController;let{signal:e}=this.#r;this.#n.addEventListener(`slotchange`,()=>this.#s(),{signal:e}),this.#a(this.getAttribute(`size`)),this.#o(this.getAttribute(`color`)),this.#i(this.getAttribute(`name`)),this.#s()}disconnectedCallback(){this.#r?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`name`:this.#i(n);break;case`size`:this.#a(n);break;case`color`:this.#o(n);break}}get name(){return this.getAttribute(`name`)}set name(e){e?this.setAttribute(`name`,e):this.removeAttribute(`name`)}get size(){return this.getAttribute(`size`)}set size(e){e?this.setAttribute(`size`,e):this.removeAttribute(`size`)}get color(){return this.getAttribute(`color`)}set color(e){e?this.setAttribute(`color`,e):this.removeAttribute(`color`)}static get catalog(){return Object.keys(ge)}#i(e){if(this.#t.innerHTML=``,!e)return;let t=be[e];if(!t){Se.has(e)||(console.warn(`[ui-icon] Ícone "${e}" não encontrado no catálogo. Use um <svg> via slot para ícones customizados.`),Se.add(e));return}let n=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);n.setAttribute(`part`,`svg`),n.setAttribute(`viewBox`,`0 0 24 24`),n.setAttribute(`xmlns`,`http://www.w3.org/2000/svg`),n.setAttribute(`fill`,`none`),n.setAttribute(`stroke`,`currentColor`),n.setAttribute(`aria-hidden`,`true`),n.innerHTML=t,this.#t.appendChild(n)}#a(e){let t=ve(e);this.style.setProperty(`--icon-size`,`${t}px`)}#o(e){let t=e||`currentColor`;this.style.setProperty(`--icon-color`,t)}#s(){let e=this.#n.assignedElements({flatten:!0}),t=e.length>0;this.#t.hidden=t,t&&e.forEach(e=>{e.setAttribute(`aria-hidden`,`true`),e.tagName?.toLowerCase()===`svg`&&!e.hasAttribute(`viewBox`)&&console.warn(`[ui-icon] SVG customizado sem atributo viewBox pode não escalar corretamente.`)}),this.dispatchEvent(new CustomEvent(`ui-icon:slotchange`,{detail:{hasSlotContent:t},bubbles:!0,composed:!0}))}};customElements.define(`ui-icon`,Ce);var we=[`top`,`bottom`,`left`,`right`],Te=new CSSStyleSheet;Te.replaceSync(`
  :host {
    position: fixed;
    z-index: 10001;
    max-width: 320px;
...
`;var Ae=class extends HTMLElement{#e;#t;#n;#r=null;static observedAttributes=[`trigger`,`placement`,`tooltip`,`tooltip-ref`,`variant`,`delay`,`offset`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.adoptedStyleSheets=[H],this.#e.appendChild(ke.content.cloneNode(!0)),this.#t=this.#e.querySelector(`slot[name="target"]`),this.#n=this.#e.querySelector(`slot[name="content"]`)}connectedCallback(){this.#t.addEventListener(`slotchange`,()=>this.#i()),this.#i()}disconnectedCallback(){this.#r?.destroy()}attributeChangedCallback(e,t,n){t===n||!this.#r||([`tooltip`,`tooltip-ref`,`variant`].includes(e)?this.#r.updateConfig(this.#a()):this.#i())}#i(){let e=this.#t.assignedElements({flatten:!0});if(!e.length)return;this.#r?.destroy();let t=e[0];this.#r=new Oe(t,this.#a())}#a(){let e=this.#n.assignedNodes({flatten:!0}),t=e.length>0?this.#o(e):void 0;return{text:this.getAttribute(`tooltip`)||void 0,templateRef:this.getAttribute(`tooltip-ref`)||void 0,contentSlot:t,placement:this.getAttribute(`placement`)||`top`,variant:this.getAttribute(`variant`)||void 0,delay:Number(this.getAttribute(`delay`)||200),offset:Number(this.getAttribute(`offset`)||8),triggers:(this.getAttribute(`trigger`)||`hover focus`).split(/\s+/)}}#o(e){let t=document.createDocumentFragment(),n=document.createElement(`div`),r=e=>{if(e.nodeType===Node.TEXT_NODE)return e.cloneNode(!1);if(e.nodeType===Node.ELEMENT_NODE){let t=e,n=document.createElement(t.nodeName.toLowerCase());for(let e of Array.from(t.attributes))n.setAttribute(e.name,e.value);for(let e of Array.from(t.childNodes))n.appendChild(r(e));return n}return e.cloneNode(!1)};e.forEach(e=>{n.appendChild(r(e))});let i=n.querySelector(`[class*="tooltip-header"], [class*="header"]`);return i&&i.classList.add(`tooltip-header`),n.querySelectorAll(`[class*="section-title"], [class*="title"]`).forEach(e=>{e.classList.add(`section-title`)}),n.querySelectorAll(`[class*="grid"]`).forEach(e=>{e.classList.add(`controls-grid`)}),n.querySelectorAll(`kbd, [class*="kbd"]`).forEach(e=>{e.classList.add(`kbd`)}),n.querySelectorAll(`[class*="desc"], [class*="text-muted"]`).forEach(e=>{e.classList.contains(`section-title`)||e.classList.add(`control-desc`)}),n.querySelectorAll(`[class*="note"], [class*="math"]`).forEach(e=>{e.classList.add(`math-note`)}),n.querySelectorAll(`[class*="mb-"], [class*="section"]`).forEach(e=>{e.classList.add(`tooltip-section`)}),t.appendChild(n),t}open(){this.#r?.open()}close(){this.#r?.close()}get isOpen(){return this.#r?.[`#isOpen`]??!1}};customElements.define(`ui-tooltip`,Ae);function U(e){if(!e)return``;let t=document.createElement(`p`);return t.textContent=e,t.innerHTML}var je=e({UIKeyboardShortcuts:()=>W}),W=class e extends HTMLElement{static shortcutsData=[];searchQuery=``;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}static renderShortcut(t,n=`default`){if(!this.shortcutsData.length)return null;let r=t.toLowerCase(),i=this.shortcutsData.find(e=>e.key&&e.key.toLowerCase()===r||e.sequence&&e.sequence.toLowerCase()===r);return i?{html:new e().formatKey(i.sequence||i.key,i.type),description:i.description}:null}set data(t){e.shortcutsData=t,this.render()}get shortcuts(){return e.shortcutsData}get variant(){return this.getAttribute(`variant`)||`default`}get categoryFilter(){return this.getAttribute(`category-filter`)}get enableSearch(){return this.hasAttribute(`enable-search`)&&this.getAttribute(`enable-search`)!==`false`}connectedCallback(){this.render(),this.setupEvents()}setupEvents(){this.shadowRoot?.addEventListener(`input`,e=>{let t=e.target;t.id===`search-input`&&(this.searchQuery=t.value.toLowerCase(),this.renderShortcuts())})}formatKey(e,t){let n=t===`sequence`?e.split(` → `):e.split(`+`),r={arrowup:`↑`,arrowdown:`↓`,arrowleft:`←`,arrowright:`→`,escape:`Esc`,delete:`Del`,backspace:`⌫`,shift:`Shift`,ctrl:`Ctrl`,alt:`Alt`},i=n.map(e=>{let t=e.toLowerCase();return`<kbd class="kbd-prism">${r[t]||(t.length===1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1))}</kbd>`});return t===`longpress`?`${i[0]} <span class="font-mono text-[8px] text-accent-primary uppercase tracking-widest ml-1.5 opacity-80 border border-accent-primary/30 px-1 py-px rounded bg-accent-primary/10">Segure</span>`:t===`sequence`?i.join(`<span class="text-text-muted/50 mx-1 text-[10px]">→</span>`):i.join(`<span class="text-text-muted/50 mx-1 text-[10px]">+</span>`)}getDescription(e){return e.description?e.description:{delete:`Excluir Seleção`,backspace:`Apagar Elemento`}[(e.key||e.sequence||``).toLowerCase()]||`Ação Desconhecida`}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
    ...
    `,this.attachEvents())}attachEvents(){let e=this.shadowRoot,t=e.getElementById(`file-input`);e.getElementById(`add-text`)?.addEventListener(`click`,()=>{r.emit(`element:add`,A.create(o.TEXT))}),e.getElementById(`add-rect`)?.addEventListener(`click`,()=>{r.emit(`element:add`,A.create(o.RECTANGLE))}),e.getElementById(`add-border`)?.addEventListener(`click`,()=>{r.emit(`element:add`,A.create(o.BORDER))}),e.getElementById(`add-image`)?.addEventListener(`click`,()=>t.click()),t?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(!t)return;let{imageProcessor:n}=await y(async()=>{let{imageProcessor:e}=await import(`./imageProcessor-CBxRY5aX.js`);return{imageProcessor:e}},__vite__mapDeps([4,3,2]),import.meta.url),i=await n.process(t),a=b.getState().currentLabel.config;r.emit(`element:add`,A.create(o.IMAGE,{dimensions:{width:w.pxToMm(i.width,a.dpi),height:w.pxToMm(i.height,a.dpi)},src:i.src}))}),e.getElementById(`open-help`)?.addEventListener(`click`,()=>{r.emit(`ui:open:help`,{tab:`guide`});let t=e.getElementById(`open-help`);t&&t.classList.remove(`pulse-help`)}),e.getElementById(`undo`)?.addEventListener(`click`,()=>r.emit(`history:undo`,{source:`toolbar`})),e.getElementById(`redo`)?.addEventListener(`click`,()=>r.emit(`history:redo`,{source:`toolbar`})),e.getElementById(`save`)?.addEventListener(`click`,async()=>{let{templateManager:e}=await y(async()=>{let{templateManager:e}=await Promise.resolve().then(()=>j);return{templateManager:e}},void 0,import.meta.url);await e.saveCurrentLabel(),r.emit(`notify`,{type:`success`,message:`Template salvo com sucesso!`})}),e.getElementById(`open-batch`)?.addEventListener(`click`,()=>{let e=document.getElementById(`batch-modal`);e&&e.setAttribute(`open`,``),p.play(p.enumPresets.OPEN)}),e.getElementById(`open-project-modal`)?.addEventListener(`click`,()=>{let e=document.getElementById(`project-modal`);e&&e.setAttribute(`open`,``),p.play(p.enumPresets.OPEN)}),document.getElementById(`btn-export-file`)?.addEventListener(`click`,async()=>{await N.exportToFile(),p.play(p.enumPresets.SUCCESS)}),document.getElementById(`btn-import-trigger`)?.addEventListener(`click`,()=>{document.getElementById(`global-import-input`)?.click()}),document.getElementById(`global-import-input`)?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t)try{await N.importFromFile(t);let e=document.getElementById(`project-modal`);e&&e.removeAttribute(`open`),p.play(p.enumPresets.SUCCESS),r.emit(`notify`,{message:`Projeto importado com sucesso!`,type:`success`})}catch(e){r.emit(`notify`,{message:`Erro ao importar: `+e.message,type:`error`})}})}};customElements.define(`editor-toolbar`,Me);function Ne(e,t=300){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)}}function Pe(e,{includeTime:t=!1,isRelative:n=!1,locale:r=`pt-BR`}={}){if(!e)throw Error(`isoString é obrigatório`);let i=new Date(e);if(isNaN(i.getTime()))throw Error(`Data inválida`);if(n){let e=Math.floor((i.getTime()-Date.now())/1e3),t=new Intl.RelativeTimeFormat(r,{numeric:`auto`});for(let[n,r]of[[31536e3,`year`],[2592e3,`month`],[86400,`day`],[3600,`hour`],[60,`minute`],[1,`second`]]){let i=Math.trunc(e/n);if(Math.abs(i)>=1)return t.format(i,r)}return t.format(0,`second`)}let a={day:`2-digit`,month:`2-digit`,year:`numeric`};return t&&Object.assign(a,{hour:`2-digit`,minute:`2-digit`,hour12:!1}),new Intl.DateTimeFormat(r,a).format(i)}var Fe=class extends HTMLElement{input;labelElement;constructor(){super(),this.attachShadow({mode:`open`}),this.labelElement=document.createElement(`label`),this.labelElement.className=`label-prism`,this.input=document.createElement(`input`),this.input.className=`input-prism`,this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}static get observedAttributes(){return[`label`,`type`,`value`,`placeholder`]}connectedCallback(){this.setupBaseStyles(),this.render(),this.setupEvents()}attributeChangedCallback(e,t,n){t!==n&&this.updateValues()}setupBaseStyles(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          margin-bottom: 12px;
    ...
    `,this.shadowRoot.appendChild(this.labelElement),this.shadowRoot.appendChild(this.input))}render(){this.updateValues()}updateValues(){let e=this.getAttribute(`label`)||``,t=this.getAttribute(`type`)||`text`,n=this.getAttribute(`value`)||``,r=this.getAttribute(`placeholder`)||``;this.labelElement.textContent=e,this.input.type=t,this.input.placeholder=r,this.input.value!==n&&(this.input.value=n)}setupEvents(){this.input.addEventListener(`input`,e=>{p.play(p.enumPresets.TAP),this.dispatchEvent(new CustomEvent(`app-input`,{detail:e.target.value,bubbles:!0,composed:!0}))})}};customElements.define(`app-input`,Fe);var Ie=class extends HTMLElement{#e;#t;#n;#r=null;#i=!1;#a=0;#o=0;#s=5;#c=0;static observedAttributes=[`value`,`min`,`max`,`step`,`label`,`unit`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.adoptedStyleSheets=[H]}get value(){return this.#t?parseFloat(this.#t.value)||0:this.#c}set value(e){let t=typeof e==`string`?parseFloat(e):e;this.#c=t,this.#t&&this.#f(t,!1)}get min(){return parseFloat(this.getAttribute(`min`)||`-Infinity`)}get max(){return parseFloat(this.getAttribute(`max`)||`Infinity`)}get step(){return parseFloat(this.getAttribute(`step`)||`1`)}connectedCallback(){this.#h(),this.#l(),this.#m()}disconnectedCallback(){this.#r?.abort()}attributeChangedCallback(e,t,n){this.#t&&(e===`value`&&this.#f(parseFloat(n),!1),e===`label`&&(this.#e.querySelector(`.label-text`).textContent=n),e===`unit`&&(this.#e.querySelector(`.scrubber-unit`).textContent=n))}#l(){this.#r=new AbortController;let{signal:e}=this.#r,t=this.#e.querySelector(`.scrubber-label`);this.#t=this.#e.querySelector(`.scrubber-input`),this.#n=this.#e.querySelector(`.scrubber-wrapper`),t.addEventListener(`pointerdown`,e=>this.#u(e),{signal:e}),this.#t.addEventListener(`keydown`,e=>this.#d(e),{signal:e}),this.#t.addEventListener(`input`,()=>p.play(p.enumPresets.TAP),{signal:e}),this.#t.addEventListener(`blur`,()=>this.#p(),{signal:e})}#u(e){let t=e.currentTarget;this.#i=!0,this.#a=e.clientX,this.#o=this.value,this.#n.classList.add(`is-scrubbing`),this.#t.style.cursor=`ew-resize`,t.setPointerCapture(e.pointerId),p.play(p.enumPresets.TAP);let n=e=>{if(!this.#i)return;let t=e.clientX-this.#a,n=e.shiftKey?10:e.altKey?.1:1,r=t/this.#s*this.step*n,i=this.#o+r;Math.abs(i-this.value)>=this.step&&p.play(p.enumPresets.TAP),this.#f(i,!0)},r=e=>{this.#i=!1,this.#n.classList.remove(`is-scrubbing`),this.#t.style.cursor=`text`,t.hasPointerCapture(e.pointerId)&&t.releasePointerCapture(e.pointerId),this.#p(),t.removeEventListener(`pointermove`,n),t.removeEventListener(`pointerup`,r)};t.addEventListener(`pointermove`,n),t.addEventListener(`pointerup`,r)}#d(e){let t=1;e.shiftKey&&(t=10),e.altKey&&(t=.1),e.key===`ArrowUp`?(e.preventDefault(),this.#f(this.value+this.step*t,!0)):e.key===`ArrowDown`?(e.preventDefault(),this.#f(this.value-this.step*t,!0)):e.key===`Enter`&&this.#t.blur()}#f(e,t){let n=Math.min(Math.max(e,this.min),this.max),r=this.getAttribute(`step`)?.includes(`.`)?2:n%1==0?0:2,i=n.toFixed(r);this.#t.value!==i&&(this.#t.value=i,this.#m(),t&&this.dispatchEvent(new CustomEvent(`input`,{detail:{value:parseFloat(i),property:this.getAttribute(`property`)},bubbles:!0,composed:!0})))}#p(){let e=this.#t.value.replace(`,`,`.`);try{if(/[^-+*/().0-9 ]/g.test(e)===!1){let t=Function(`return (${e})`)();this.#f(t,!1)}}catch{this.#f(this.value,!1)}this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value,property:this.getAttribute(`property`)},bubbles:!0,composed:!0}))}#m(){if(this.min===-1/0||this.max===1/0)return;let e=(this.value-this.min)/(this.max-this.min)*100;this.style.setProperty(`--progress`,`${Math.max(0,Math.min(100,e))}%`)}#h(){let e=this.getAttribute(`label`)||``,t=this.getAttribute(`value`)||`0`,n=this.getAttribute(`unit`)||``;this.#e.innerHTML=`
      <style>
    ...
    `;let o=this.shadowRoot.getElementById(`select-preset`);o&&(o.options=c)}setupListeners(){let e=this.shadowRoot,t=t=>{let n=t.target.getAttribute(`data-prop`);if(n===`doc.widthMM`||n===`doc.heightMM`){let t=e.getElementById(`select-preset`);t&&(t.value=`custom`)}if(!n)return;let r=q(t);r!==void 0&&G(this,{prop:n,value:r})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t),e.getElementById(`select-preset`)?.addEventListener(`app-select`,e=>{let t=e.detail,n=c.find(e=>e.value===t);n&&n.value!==`custom`&&(G(this,{prop:`doc.widthMM`,value:n.w}),G(this,{prop:`doc.heightMM`,value:n.h}))}),e.getElementById(`btn-open-vault`)?.addEventListener(`click`,()=>{K(this,{action:`open-vault`})})}syncValues(){if(!this.shadowRoot||!this._labelConfig||!this._preferences)return;let e=this.shadowRoot,t=this._labelConfig,n=this._preferences,r=e.getElementById(`select-preset`);if(r){let e=c.find(e=>e.w===t.widthMM&&e.h===t.heightMM),n=e?e.value:`custom`;r.value!==n&&(r.value=n)}e.querySelectorAll(`[data-prop]`).forEach(r=>{let i=r.getAttribute(`data-prop`);if(!i)return;let a=r instanceof HTMLInputElement&&r.type===`checkbox`;if(!((e.activeElement===r||r.shadowRoot?.activeElement)&&!a))if(i===`doc.widthMM`)r.value!=t.widthMM&&(r.value=t.widthMM);else if(i===`doc.heightMM`)r.value!=t.heightMM&&(r.value=t.heightMM);else if(i===`doc.dpi`)r.value!=t.dpi&&(r.value=t.dpi);else if(i===`doc.previewScale`)r.value!=t.previewScale&&(r.value=t.previewScale);else if(i===`doc.backgroundColor`){let e=t.backgroundColor||`#ffffff`;r.value!=e&&(r.value=e)}else i===`pref.audioEnabled`?r.checked!==n.audioEnabled&&(r.checked=n.audioEnabled):i===`pref.showGrid`?r.checked!==n.showGrid&&(r.checked=n.showGrid):i===`pref.gridSizeMM`?r.value!=n.gridSizeMM&&(r.value=n.gridSizeMM):i===`pref.unit`&&r instanceof HTMLSelectElement&&r.value!==n.unit&&(r.value=n.unit)})}syncDigitalTwin(){let e=this.shadowRoot?.getElementById(`monitor-img`);e&&(e.src=this._thumbnailUrl)}};customElements.define(`inspector-document-setup`,Be);function J(e){return`dimensions`in e}var Ve=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}set element(e){this._element=e,this.syncValues()}get element(){return this._element}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element,t=e.keepRatio===!0;this.shadowRoot.innerHTML=`
      <style>
    ...
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);if(n!=null){if(this._element&&this._element.keepRatio&&J(this._element)){let e=this._element,r=e.dimensions.width,i=e.dimensions.height,a=i===0?1:r/i;if(t===`dimensions.width`){let e=Number(n),t=Number((e/a).toFixed(2));G(this,{prop:`dimensions`,value:{width:e,height:t}});return}if(t===`dimensions.height`){let e=Number(n),t=Number((e*a).toFixed(2));G(this,{prop:`dimensions`,value:{width:t,height:e}});return}}G(this,{prop:t,value:n})}};e.addEventListener(`input`,t),e.addEventListener(`change`,t),e.addEventListener(`app-input`,t),e.getElementById(`btn-toggle-ratio`)?.addEventListener(`click`,()=>{if(!this._element)return;let e=!this._element.keepRatio;G(this,{prop:`keepRatio`,value:e}),p.play(p.enumPresets.TOGGLE)})}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot,n=t.getElementById(`btn-toggle-ratio`),r=t.querySelector(`.ratio-link-container`);if(n&&r){let t=e.keepRatio===!0;n.classList.toggle(`active`,t),r.classList.toggle(`active`,t),n.setAttribute(`title`,t?`Unlock Aspect Ratio`:`Lock Aspect Ratio`)}t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r)return;let i=t.activeElement===n||n.shadowRoot?.activeElement,a=n.classList.contains(`is-scrubbing`);if(!i&&!a){let t;r===`position.x`?t=e.position.x:r===`position.y`?t=e.position.y:r===`rotation`?t=e.rotation:r===`opacity`?t=e.opacity:r===`dimensions.width`&&J(e)?t=e.dimensions.width:r===`dimensions.height`&&J(e)&&(t=e.dimensions.height);let i=n.value===void 0?n.getAttribute(`value`):n.value;t!==void 0&&String(i)!==String(t)&&(n.value=t,n.setAttribute(`value`,String(t)))}})}};customElements.define(`inspector-section-transform`,Ve);var He=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      ...
      <div class="row-ui">
        ...
        <app-input label="Weight" data-prop="fontWeight" value="${U(String(e.fontWeight))}" class="fixed-small"></app-input>
      </div>
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;r===`content`?i=e.content:r===`fontSize`?i=e.fontSize:r===`lineHeight`?i=e.lineHeight:r===`color`?i=e.color:r===`fontWeight`&&(i=e.fontWeight);let a=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&a!=i&&(n.value=i,n.setAttribute(`value`,String(i)))})}};customElements.define(`inspector-section-text`,He);var Ue=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      <style>
        :host { display: flex; flex-direction: column; gap: 8px; }
        .row-ui { display: flex; gap: 10px; align-items: flex-end; }
        .row-ui > * { flex: 1; min-width: 0; }
    ...
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;r===`fillColor`?i=e.fillColor:r===`strokeColor`?i=e.strokeColor:r===`borderRadius`?i=e.borderRadius:r===`strokeWidth`&&(i=e.strokeWidth);let a=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&a!=i&&(n.value=i,n.setAttribute(`value`,String(i)))})}};customElements.define(`inspector-section-rect`,Ue);var We=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      <style>
        :host { display: flex; flex-direction: column; gap: 8px; }
      ...
      <div class="row-ui">
        <app-input label="Fit Mode" data-prop="fit" value="${U(e.fit)}" style="flex:1"></app-input>
      </div>
    ...
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(r&&!(t.activeElement===n||n.shadowRoot?.activeElement)){if(r===`fit`)(n.value===void 0?n.getAttribute(`value`):n.value)!=e.fit&&(n.value=e.fit,n.setAttribute(`value`,e.fit));else if(r===`smoothing`){let t=e.smoothing!==!1;n.checked!==t&&(n.checked=t)}}})}};customElements.define(`inspector-section-image`,We);var Ge=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      <style>
        :host { display: flex; flex-direction: column; gap: 8px; }
        .row-ui { display: flex; gap: 10px; align-items: flex-end; }
        .row-ui > * { flex: 1; min-width: 0; }
      ...
      <div class="row-ui">
        <app-input label="Style" data-prop="style" value="${U(e.style)}" style="flex:1"></app-input>
        <app-input label="Color" type="color" data-prop="color" value="${U(e.color)}" class="fixed-small"></app-input>
      </div>
      <div class="row-ui">
    ...
    `,e.appendChild(n);let r=e=>{let n=document.createElement(e);return n.setAttribute(`data-inspector-section`,``),n.element=t,n};e.appendChild(r(`inspector-section-transform`)),t.type===o.TEXT?e.appendChild(r(`inspector-section-text`)):t.type===o.RECTANGLE?e.appendChild(r(`inspector-section-rect`)):t.type===o.IMAGE?e.appendChild(r(`inspector-section-image`)):t.type===o.BORDER&&e.appendChild(r(`inspector-section-border`));let i=document.createElement(`div`);i.style.marginTop=`16px`,i.style.display=`flex`,i.style.gap=`8px`,i.innerHTML=`
...
`;var Ye={danger:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    ...
    `,r.onclick=()=>{N.createNewProject(),this.closeVault(),p.play(p.enumPresets.OPEN)},n.appendChild(r),t.forEach(e=>{let t=document.createElement(`div`);t.innerHTML=this.renderCartridgeHtml(e),n.appendChild(t.firstElementChild)}),e.innerHTML=``,e.appendChild(n)}renderCartridgeHtml(e){let t=Pe(new Date(e.updatedAt).toISOString(),{isRelative:!0}),n=Pe(new Date(e.updatedAt).toISOString(),{includeTime:!0}),r=e.config.widthMM/e.config.heightMM,i=this.getElementSummary(e);return`
    ...
    `,i=``;return t.text>0&&(i+=r(`text`,`Text`,t.text)),t.image>0&&(i+=r(`image`,`Images`,t.image)),t.shape>0&&(i+=r(`rect`,`Shapes`,t.shape)),t.border>0&&(i+=r(`rect`,`Borders`,t.border)),n===0&&(i=`<div class="text-[9px] text-text-muted italic opacity-60 py-1">No layers detected</div>`),{total:n,rows:i}}attachEventsOnce(){let e=this.shadowRoot;this.abortController=new AbortController;let{signal:t}=this.abortController;r.on(`template:saved`,()=>{setTimeout(()=>{this.loadAndRender()},500)}),e.getElementById(`vault-import-btn`)?.addEventListener(`click`,()=>{document.getElementById(`global-import-input`)?.click()}),e.querySelectorAll(`.filter-btn`).forEach(e=>{e.addEventListener(`click`,e=>{this.filter=e.currentTarget.dataset.filter||`all`,p.play(p.enumPresets.TAP),this.render()},{signal:t})}),e.addEventListener(`click`,async e=>{let t=e.target,n=t.closest(`.action-load`),r=t.closest(`.action-duplicate`),i=t.closest(`.action-delete`),a=t.closest(`.action-export-label`);if(a){let e=a.dataset.id,t=this.templates.find(t=>t.id===e);t&&(N.exportToFile(t),p.play(p.enumPresets.SUCCESS))}if(n){let e=n.dataset.id;await N.loadTemplate(e),p.play(p.enumPresets.SUCCESS),this.closeVault()}if(r){let e=r.dataset.id;setTimeout(async()=>{await N.duplicateTemplate(e),p.play(p.enumPresets.TAP),this.loadAndRender()},300)}if(i){let e=i.dataset.id;if(await Qe.ask(`Excluir template?`,`Esta ação não pode ser desfeita.`,{variant:`danger`,confirmText:`Excluir definitivamente`,cancelText:`Cancelar`,countdown:1})){let n=t.closest(`[data-id]`);n&&n.classList.add(`fade-out`),setTimeout(async()=>{await N.deleteTemplate(e),p.play(p.enumPresets.DELETE),this.loadAndRender()},300)}}},{signal:t})}closeVault(){let e=document.getElementById(`vault-modal`);e&&e.removeAttribute(`open`)}};customElements.define(`vault-gallery`,$e);var et=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}connectedCallback(){this.render(),this.setupEvents()}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
        :host { display: block; }
    ...
    `}setupEvents(){let e=this.shadowRoot;if(e.querySelectorAll(`[data-tab]`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.tab;t!==this.activeTab&&(this.activeTab=t,p.play(p.enumPresets.TAP),this.render())})}),this.activeTab===`shortcuts`){let t=e.getElementById(`shortcut-viewer`);t&&(t.data=I.listShortcuts())}}};customElements.define(`ui-help-center`,tt);var nt=[`default`,`success`,`danger`,`warning`,`info`],rt=[`sm`,`md`,`lg`,`xl`,`fullscreen`],it=[`fade`,`scale`,`slide`,`flip`],at={default:{accent:`#6366f1`,fg:`#fff`,icon:null},success:{accent:`#16a34a`,fg:`#fff`,icon:`✓`},danger:{accent:`#dc2626`,fg:`#fff`,icon:`!`},warning:{accent:`#d97706`,fg:`#fff`,icon:`⚠`},info:{accent:`#0284c7`,fg:`#fff`,icon:`i`}},ot={sm:`28rem`,md:`40rem`,lg:`56rem`,xl:`72rem`,fullscreen:`100vw`};function X(e){return nt.includes(e)}function Z(e){return rt.includes(e)}function st(e){return it.includes(e)}var ct=`
  :host {
    display: contents;
...
`,ut=`a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"]),details>summary`,dt=class extends HTMLElement{#e;#t;#n=null;#r;#i;#a;#o;#s;#c;#l;#u=!1;#d=!1;#f=null;static observedAttributes=[`variant`,`size`,`animation`,`heading`,`open`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#t=this.attachInternals();let e=new CSSStyleSheet;e.replaceSync(ct),this.#e.adoptedStyleSheets=[e],this.#e.innerHTML=lt,this.#m()}connectedCallback(){if(this.#d)return;this.#d=!0,this.#n=new AbortController;let e=this.#n.signal;this.#a.addEventListener(`click`,()=>this.close(),{signal:e}),this.#r.addEventListener(`click`,e=>{e.target===this.#r&&this.#b()},{signal:e}),this.#l.addEventListener(`slotchange`,()=>{let e=this.#l.assignedNodes({flatten:!0}).length>0;this.#c.classList.toggle(`hidden`,!e)},{signal:e}),this.#r.addEventListener(`keydown`,e=>{if(e.key===`Escape`){e.preventDefault(),this.#b();return}e.key===`Tab`&&this.#C(e)},{signal:e}),this.#h()}disconnectedCallback(){this.#d=!1,this.#n?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`variant`:this.#g(n);break;case`size`:this.#_(n);break;case`animation`:break;case`heading`:this.#o.textContent=n??``;break;case`open`:{let e=n!==null;e&&!this.#p&&!this.#u&&this.#v(),!e&&this.#p&&!this.#u&&this.#y(),p.play(p.enumPresets.SWOOSHIN);break}}}open(){this.#p||this.#u||this.setAttribute(`open`,``)}close(){!this.#p||this.#u||this.removeAttribute(`open`)}toggle(){this.#p?this.close():this.open()}get isOpen(){return this.#p}get variant(){let e=this.getAttribute(`variant`);return X(e)?e:`default`}set variant(e){this.setAttribute(`variant`,X(e)?e:`default`)}get size(){let e=this.getAttribute(`size`);return Z(e)?e:`md`}set size(e){this.setAttribute(`size`,Z(e)?e:`md`)}get animation(){let e=this.getAttribute(`animation`);return st(e)?e:`scale`}set animation(e){this.setAttribute(`animation`,st(e)?e:`scale`)}get heading(){return this.getAttribute(`heading`)??``}set heading(e){this.setAttribute(`heading`,e)}addEventListener(e,t,n){super.addEventListener(e,t,n)}removeEventListener(e,t,n){super.removeEventListener(e,t,n)}get#p(){return this.#r.classList.contains(`is-open`)}#m(){let e=e=>this.#e.querySelector(e);this.#r=e(`.overlay`),this.#i=e(`.panel`),this.#a=e(`.close-btn`),this.#o=e(`#modal-title`),this.#s=e(`.icon-badge`),this.#c=e(`.footer`),this.#l=e(`slot[name="footer"]`)}#h(){this.hasAttribute(`variant`)&&this.#g(this.getAttribute(`variant`)),this.hasAttribute(`size`)&&this.#_(this.getAttribute(`size`)),this.hasAttribute(`heading`)&&(this.#o.textContent=this.getAttribute(`heading`)),this.hasAttribute(`open`)&&this.#v()}#g(e){let t=at[X(e)?e:`default`],n=this.#e.host;n.style.setProperty(`--_accent`,t.accent),n.style.setProperty(`--_fg`,t.fg),this.#s.textContent=t.icon??``}#_(e){let t=Z(e)?e:`md`;this.#i.style.setProperty(`--_width`,ot[t])}#v(){this.#u=!0,this.#f=document.activeElement,this.#r.classList.add(`is-open`),this.#r.removeAttribute(`aria-hidden`),this.#t.states?.add(`open`),r.emit(`ui:modal:open`,{id:this.id}),requestAnimationFrame(()=>{(this.#T()??this.#a).focus(),this.#u=!1}),this.#S(`ui-modal:open`)}#y(e=!1){this.#u=!0,this.#r.classList.replace(`is-open`,`is-closing`);let t=this.#x(getComputedStyle(this.#r).getPropertyValue(`--_dur`));setTimeout(()=>{this.#r.classList.remove(`is-closing`),this.#r.setAttribute(`aria-hidden`,`true`),this.#t.states?.delete(`open`),this.#u=!1,this.#f?.focus?.(),this.#f=null,r.emit(`ui:modal:close`,{id:this.id}),e&&this.#S(`ui-modal:cancel`),this.#S(`ui-modal:close`)},t)}#b(){!this.#p||this.#u||this.removeAttribute(`open`)}#x(e){let t=e.trim().match(/^(\d+(?:\.\d+)?)(ms|s)?$/);if(!t||t[1]===void 0)return 280;let n=parseFloat(t[1]);return(t[2]??`ms`)===`s`?n*1e3:n}#S(e){let t={modal:this};this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}#C(e){let t=this.#w();if(!t.length){e.preventDefault(),this.#a.focus();return}let n=t[0],r=t[t.length-1],i=this.#e.activeElement instanceof HTMLSlotElement?document.activeElement:this.#e.activeElement;if(!i||!t.includes(i)){e.preventDefault(),n.focus();return}e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}#w(){return[...Array.from(this.#e.querySelectorAll(ut)),...Array.from(this.querySelectorAll(ut))]}#T(){return this.#w().find(e=>e!==this.#a)??null}};customElements.define(`ui-modal`,dt);var ft=1500,pt=2e3,Q={copy:`<ui-icon name="copy"  size="xs"></ui-icon>`,check:`<ui-icon name="check-circle" size="xs"></ui-icon>`,error:`<ui-icon name="alert-circle" size="xs"></ui-icon>`},mt={missing:`variável ausente no template`,used:`variável mapeada`,default:`variável disponível`},ht=document.createElement(`template`);ht.innerHTML=`
  <style>
    :host {
      display: inline-flex;
      cursor: pointer;
...
`;var gt=class extends HTMLElement{#e;#t=null;#n=null;#r;#i;#a;static observedAttributes=[`state`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(ht.content.cloneNode(!0)),this.#r=this.#e.querySelector(`[part="root"]`),this.#i=this.#e.querySelector(`[part="icon"]`),this.#a=this.#e.querySelector(`slot`)}connectedCallback(){this.#t=new AbortController;let{signal:e}=this.#t;this.#r.addEventListener(`click`,()=>this.#s(),{signal:e}),this.#r.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.#s())},{signal:e}),this.#a.addEventListener(`slotchange`,()=>this.#l(),{signal:e}),this.#l()}disconnectedCallback(){this.#t?.abort(),this.#t=null,this.#n!==null&&(clearTimeout(this.#n),this.#n=null)}attributeChangedCallback(e,t,n){e===`state`&&t!==n&&this.#l()}get state(){return this.getAttribute(`state`)??`default`}set state(e){this.setAttribute(`state`,e)}#o(){return this.#a.assignedNodes({flatten:!0}).map(e=>e.textContent??``).join(``).trim()}async#s(){let e=this.#o();if(e)try{await navigator.clipboard.writeText(e),this.#c(`copied`),this.dispatchEvent(new CustomEvent(`ui-badge-copied`,{detail:{value:e},bubbles:!0,composed:!0}))}catch(e){this.#c(`error`),console.warn(`[ui-variable-badge] Falha ao copiar para área de transferência:`,e),this.dispatchEvent(new CustomEvent(`ui-badge-copy-error`,{detail:{reason:e},bubbles:!0,composed:!0}))}}#c(e){this.#n!==null&&(clearTimeout(this.#n),this.removeAttribute(`data-copied`),this.removeAttribute(`data-error`));let t=e===`copied`,n=t?ft:pt,r=t?`data-copied`:`data-error`,i=t?`Copiado!`:`Falha ao copiar`;this.#r.setAttribute(`aria-pressed`,`true`),this.#i.innerHTML=t?Q.check:Q.error,this.setAttribute(r,``),this.#r.setAttribute(`aria-label`,i),this.#n=setTimeout(()=>{this.removeAttribute(r),this.#i.innerHTML=Q.copy,this.#r.setAttribute(`aria-pressed`,`false`),this.#l(),this.#n=null},n)}#l(){let e=this.#o(),t=mt[this.state]??`variável`,n=`${e||`badge`} — ${t}. Clique para copiar.`;this.#r.setAttribute(`aria-label`,n),this.#r.setAttribute(`aria-pressed`,`false`)}};customElements.define(`ui-variable-badge`,gt);var _t=class extends HTMLElement{dataList=[];currentFileName=``;dataFields=[];labelPlaceholders=[];a4Config={marginMM:10,gapMM:5,columns:2,showCropMarks:!0,bleedMM:2,zoom:.45};isDragging=!1;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[H])}connectedCallback(){this.render()}refreshLabelPlaceholders(){let e=b.getState().currentLabel;if(!e)return;let t=new Set,n=/\{\{\s*([\w\s."'-]+)(?::([\w,()\s.:-]+))?(?:\|\|([^}]+))?\s*\}\}/g;e.elements.forEach(e=>{if(e.type===o.TEXT&&e.content){let r=e.content,i;for(;(i=n.exec(r))!==null;)t.add(i[1].trim())}}),this.labelPlaceholders=Array.from(t)}render(){if(!this.shadowRoot)return;this.refreshLabelPlaceholders();let e=this.isDragging?`drop-zone dragging`:`drop-zone`;this.shadowRoot.innerHTML=`
      <style>
        :host { display: block; height: 100%; }
    ...
    `}updatePreview(){let e=this.shadowRoot,t=e.getElementById(`a4-sheet`),n=b.getState().currentLabel;if(t.style.setProperty(`--a4-margin`,`${this.a4Config.marginMM}mm`),t.style.setProperty(`--a4-gap`,`${this.a4Config.gapMM}mm`),t.style.setProperty(`--a4-cols`,`${this.a4Config.columns}`),!n||this.dataList.length===0){t.innerHTML=`
...
`);var yt=document.createElement(`template`);yt.innerHTML=`
  <div
    class="hud-banner"
    part="banner"
    role="region"
...
`;function $(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function bt(e){let t=[],n=0,r=/\[([^\]]+)\]/g,i;for(;(i=r.exec(e))!==null;){i.index>n&&t.push(`<span>${$(e.slice(n,i.index))}</span>`);let a=i[1],o=W.renderShortcut(a);o?t.push(`<span class="kbd-group" aria-label="Atalho: ${$(o.description)}">${o.html}</span>`):t.push(`<kbd class="kbd-prism">${$(a)}</kbd>`),n=r.lastIndex}return n<e.length&&t.push(`<span>${$(e.slice(n))}</span>`),t.join(``)}function xt(e){return e.replace(/\[([^\]]+)\]/g,(e,t)=>{let n=W.renderShortcut(t);return n?n.description:t})}function St(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}var Ct=class extends HTMLElement{#e;#t=new AbortController;#n=[];#r=0;#i=null;#a=!1;#o=!1;#s=!1;#c=15e3;#l=null;#u=null;#d=null;constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.adoptedStyleSheets=[H,vt],this.#e.appendChild(yt.content.cloneNode(!0)),this.#l=this.#e.getElementById(`tip-text`),this.#u=this.#e.getElementById(`sr-text`),this.#d=this.#e.getElementById(`btn-close`)}connectedCallback(){let e=this.#t.signal,t=this.#e.querySelector(`.hud-banner`),n=parseInt(getComputedStyle(this).getPropertyValue(`--hud-tip-interval-ms`).trim(),10);!isNaN(n)&&n>0&&(this.#c=n),t?.addEventListener(`mouseenter`,()=>{this.#a=!0},{signal:e}),t?.addEventListener(`mouseleave`,()=>{this.#a=!1},{signal:e}),this.#d?.addEventListener(`click`,()=>this.#g(),{signal:e}),this.#n.length>0&&(this.#m(!1),this.#f())}disconnectedCallback(){this.#t.abort(),this.#p()}setTips(e){if(!Array.isArray(e)||e.length===0){this.setAttribute(`data-empty`,``);return}this.removeAttribute(`data-empty`),this.#n=St(e),this.#r=0,this.#m(!1),this.isConnected&&(this.#p(),this.#f())}pause(){this.#o=!0,this.#p()}resume(){this.#o&&(this.#o=!1,this.#f())}#f(){this.#i===null&&(this.#n.length<=1||(this.#i=window.setInterval(()=>{this.#a||this.#o||this.#s||(this.#r=(this.#r+1)%this.#n.length,this.#m(!0))},this.#c)))}#p(){this.#i!==null&&(clearInterval(this.#i),this.#i=null)}#m(e){let t=this.#l,n=this.#u;if(!t||this.#n.length===0)return;let r=this.#n[this.#r],i=bt(r),a=xt(r);if(n&&(n.textContent=`Dica: ${a}`),!e){t.innerHTML=this.#h(i),t.dataset.state=`visible`;return}this.#s=!0,t.dataset.state=`exit-up`,setTimeout(()=>{t.innerHTML=this.#h(i),t.dataset.state=`enter-from-bottom`,t.offsetWidth,t.dataset.state=`visible`,setTimeout(()=>{this.#s=!1},450)},450)}#h(e){return`<span class="tip-prefix" aria-hidden="true">Dica:</span>${e}`}#g(){this.style.opacity=`0`,this.style.transform=`translateY(8px)`,this.style.transition=`opacity 0.3s ease, transform 0.3s ease`,this.dispatchEvent(new CustomEvent(`hud-close`,{detail:{permanent:!1},bubbles:!0,composed:!0})),setTimeout(()=>{this.#p(),this.remove()},300)}};customElements.define(`ui-hud-tips`,Ct),r.on(`notify`,e=>{oe.show(e)}),r.on(`ui:open:help`,(e={})=>{localStorage.setItem(`has_seen_guide`,`true`);let t=document.getElementById(`help-center-modal`),n=t?.querySelector(`ui-help-center`);t&&n&&(e.tab&&n.setTab(e.tab),t.setAttribute(`open`,``),p.play(p.enumPresets.OPEN))});var wt={id:crypto.randomUUID(),name:`Nova Etiqueta`,config:{...u.CANVAS},elements:[A.create(o.TEXT,{content:`Minha Nova Etiqueta`})],createdAt:Date.now(),updatedAt:Date.now()};document.addEventListener(`DOMContentLoaded`,async()=>{let{isMac:e}=de(),{preferenceManager:t}=await y(async()=>{let{preferenceManager:e}=await import(`./PreferenceManager-J5WL3x9C.js`);return{preferenceManager:e}},__vite__mapDeps([0,1,2,3]),import.meta.url),n=await t.getPreferences();p.toggle(n.audioEnabled);let i=()=>{p.play(p.enumPresets.TAP)&&(document.removeEventListener(`click`,i),document.removeEventListener(`keydown`,i))};document.addEventListener(`click`,i,{once:!0}),document.addEventListener(`keydown`,i,{once:!0}),r.on(`preferences:change`,e=>{e.audioEnabled!==void 0&&p.toggle(e.audioEnabled)}),await N.init(),I.init(e);let a=I.listShortcuts(),{UIKeyboardShortcuts:o}=await y(async()=>{let{UIKeyboardShortcuts:e}=await Promise.resolve().then(()=>je);return{UIKeyboardShortcuts:e}},void 0,import.meta.url),s=new o;s.data=a,document.querySelector(`ui-hud-tips`)?.setTips([...a.map(e=>`[${e.key||e.sequence}] - ${e.description}`),...Y.proTips.map(e=>e.tip),`Dica: Use Ctrl+Z para desfazer ações.`,`Dica: Use as setas do teclado para mover elementos selecionados.`]);let c=localStorage.getItem(`last_active_project`),l=localStorage.getItem(`has_seen_guide`)===`true`,u=!1;if(c){let e=(await N.getTemplates()).find(e=>e.id===c);e&&(b.loadLabel(e),u=!0,r.emit(`notify`,{type:`success`,message:`Sessão anterior restaurada.`,duration:3e3}),p.play(p.enumPresets.SUCCESS))}if(!u&&!l){let e=document.getElementById(`welcome-modal`);e&&e.setAttribute(`open`,``),b.loadLabel(wt)}else u||(b.loadLabel(wt),d.info(`Main`,`Standard session initialized: ${wt.id}`));r.emit(`preferences:update`,n),r.on(`state:change`,e=>{e.currentLabel?.id&&localStorage.setItem(`last_active_project`,e.currentLabel.id)}),d.info(`Main`,`Application Initialized`),r.emit(`notify`,{type:`info`,message:`Aplicação inicializada com sucesso!`,duration:5e3})});export{y as i,w as n,S as r,k as t};