...
`;function ue(e){return e===`success`||e===`error`||e===`warning`||e===`info`}var de=class extends HTMLElement{#e;#t=null;#n=null;#r=null;#i;#a;#o;#s;static observedAttributes=[`type`,`message`,`duration`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(le.content.cloneNode(!0)),this.#i=this.#e.querySelector(`[part="toast-root"]`),this.#a=this.#e.querySelector(`[part="toast-icon"]`),this.#o=this.#e.querySelector(`[part="toast-body"]`),this.#s=this.#e.querySelector(`[part="toast-bar"]`)}connectedCallback(){this.#t=new AbortController;let{signal:e}=this.#t;this.#d(this.getAttribute(`type`)),this.#f(this.getAttribute(`message`)??B.message),this.#p(),this.#m(),this.#e.querySelector(`[part="toast-close"]`).addEventListener(`click`,()=>{this.dismiss()},{signal:e}),requestAnimationFrame(()=>{this.setAttribute(`data-visible`,``)})}disconnectedCallback(){this.#t?.abort(),this.#n!==null&&clearTimeout(this.#n),this.#r?.cancel()}attributeChangedCallback(e,t,n){t===n||!this.isConnected||(e===`type`?this.#d(n):e===`message`?this.#f(n??B.message):e===`duration`&&(this.#r?.cancel(),this.#r=null,this.#p(),this.#m()))}dismiss(){this.removeAttribute(`data-visible`);let e=parseFloat(getComputedStyle(this).getPropertyValue(`--toast-duration-ms`).trim())||oe;setTimeout(()=>{let e=new CustomEvent(`ui-toast:dismissed`,{bubbles:!0,composed:!0,detail:{type:this.#c,message:this.#l}});this.dispatchEvent(e),this.remove()},e)}get#c(){let e=this.getAttribute(`type`);return ue(e)?e:B.type}get#l(){return this.getAttribute(`message`)??B.message}get#u(){let e=parseInt(this.getAttribute(`duration`)??``,10);return Number.isFinite(e)&&e>=0?e:B.duration}#d(e){let t=ue(e)?e:B.type,n=ce[t];this.#a.innerHTML=se[t],this.#i.setAttribute(`role`,n),this.#i.setAttribute(`aria-live`,n===`alert`?`assertive`:`polite`)}#f(e){this.#o.textContent=e}#p(){let e=this.#u;if(e<=0){this.#s.style.display=`none`;return}this.#s.style.display=``,this.#r=this.#s.animate([{transform:`scaleX(1)`},{transform:`scaleX(0)`}],{duration:e,fill:`forwards`,easing:`linear`})}#m(){this.#n!==null&&(clearTimeout(this.#n),this.#n=null);let e=this.#u;e>0&&(this.#n=setTimeout(()=>{this.dismiss()},e))}};customElements.define(`ui-toast`,de);var fe=class e extends HTMLElement{#e;static MAX_TOASTS=5;constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.innerHTML=`
    ...
    `,this.workspace.className=`canvas-workspace`;let e=document.createElement(`div`);e.className=`artboard-scaler`,e.id=`scaler`,this.artboard.className=`label-artboard`,this.artboard.appendChild(this.canvas),e.appendChild(this.artboard),this.workspace.appendChild(e),this.shadowRoot.appendChild(this.workspace)}setupListeners(){this.unsubscribe=r.on(`state:change`,e=>{this.redraw(e),this.updateWorkspaceVisuals(e)}),r.on(`request:canvas:snapshot`,e=>{e(this.ctx)}),r.on(`command:canvas:restore`,e=>{this.ctx.putImageData(e,0,0)}),this.canvas.addEventListener(`mousedown`,e=>this.handleMouseDown(e))}updateWorkspaceVisuals(e){}redraw(e=C.getState()){let t=e.currentLabel;if(!t)return;let{config:n,elements:r}=t,i=n.previewScale,a=N.mmToPx(1,n.dpi),o=window.devicePixelRatio*96/n.dpi,s=N.mmToPx(t.config.widthMM,n.dpi),c=N.mmToPx(t.config.heightMM,n.dpi);this.artboard.style.width=`${s}px`,this.artboard.style.height=`${c}px`,this.artboard.style.backgroundColor=n.backgroundColor||`#ffffff`;let l=i*o;this.artboard.style.transform=`translate(-50%, -50%) scale(${l})`;let u=this.shadowRoot?.getElementById(`scaler`);u&&(u.style.width=`${s*l}px`,u.style.height=`${c*l}px`),this.canvas.width=s,this.canvas.height=c,this.canvas.style.width=`100%`,this.canvas.style.height=`100%`,this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.fillStyle=n.backgroundColor||`#ffffff`,this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),r.filter(e=>e.visible!==!1).sort((e,t)=>e.zIndex-t.zIndex).forEach(t=>{L.render(t,{ctx:this.ctx,scale:a,dpi:n.dpi}),e.selectedElementIds.includes(t.id)&&this.drawSelectionOutline(t,a,n.dpi)}),e.preferences.showGrid&&this.drawGridOverlay(e,a)}drawGridOverlay(e,t){let{gridSizeMM:n,gridColor:r,gridOpacity:i}=e.preferences,{widthMM:a,heightMM:o}=e.currentLabel.config,s=n*t;this.ctx.save(),this.ctx.beginPath(),this.ctx.strokeStyle=r||`rgba(99, 102, 241, 0.15)`,this.ctx.globalAlpha=i??.3,this.ctx.lineWidth=.5;for(let e=0;e<=a*t;e+=s)this.ctx.moveTo(e,0),this.ctx.lineTo(e,o*t);for(let e=0;e<=o*t;e+=s)this.ctx.moveTo(0,e),this.ctx.lineTo(a*t,e);this.ctx.stroke(),this.ctx.restore()}drawSelectionOutline(e,t,n){e.dimensions&&(this.ctx.save(),this.ctx.strokeStyle=`#6366f1`,this.ctx.lineWidth=N.ptToPx(this.selectionOutlineBorderWidth,n)*(t/N.mmToPx(1,n)),this.ctx.setLineDash([5,5]),this.ctx.strokeRect(e.position.x*t,e.position.y*t,e.dimensions.width*t,e.dimensions.height*t),this.ctx.restore())}handleMouseDown(e){let t=this.canvas.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*this.canvas.width,i=(e.clientY-t.top)/t.height*this.canvas.height,a=C.getState();if(!a.currentLabel)return;let o=[...a.currentLabel.elements].sort((e,t)=>t.zIndex-e.zIndex).find(e=>L.hitTest(e,n,i,a.currentLabel.config));o?(r.emit(`element:select`,o.id),g.play(g.enumPresets.SELECT)):r.emit(`element:select`,[])}};customElements.define(`editor-canvas`,we);var Te=class extends HTMLElement{button;constructor(){super(),this.attachShadow({mode:`open`}),this.button=document.createElement(`button`),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}static get observedAttributes(){return[`variant`,`disabled`]}connectedCallback(){this.setupBaseStyles(),this.render(),this.setupEvents()}attributeChangedCallback(){this.render()}setupBaseStyles(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
...
`;var Me=new Set,Ne=class extends HTMLElement{#e;#t;#n;#r=null;static observedAttributes=[`name`,`size`,`color`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(je.content.cloneNode(!0)),this.#t=this.#e.getElementById(`icon-container`),this.#n=this.#e.querySelector(`slot`)}connectedCallback(){this.#r=new AbortController;let{signal:e}=this.#r;this.#n.addEventListener(`slotchange`,()=>this.#s(),{signal:e}),this.#a(this.getAttribute(`size`)),this.#o(this.getAttribute(`color`)),this.#i(this.getAttribute(`name`)),this.#s()}disconnectedCallback(){this.#r?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`name`:this.#i(n);break;case`size`:this.#a(n);break;case`color`:this.#o(n);break}}get name(){return this.getAttribute(`name`)}set name(e){e?this.setAttribute(`name`,e):this.removeAttribute(`name`)}get size(){return this.getAttribute(`size`)}set size(e){e?this.setAttribute(`size`,e):this.removeAttribute(`size`)}get color(){return this.getAttribute(`color`)}set color(e){e?this.setAttribute(`color`,e):this.removeAttribute(`color`)}static get catalog(){return Object.keys(Ee)}#i(e){if(this.#t.innerHTML=``,!e)return;let t=Ae[e];if(!t){Me.has(e)||(console.warn(`[ui-icon] Ícone "${e}" não encontrado no catálogo. Use um <svg> via slot para ícones customizados.`),Me.add(e));return}let n=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);n.setAttribute(`part`,`svg`),n.setAttribute(`viewBox`,`0 0 24 24`),n.setAttribute(`xmlns`,`http://www.w3.org/2000/svg`),n.setAttribute(`fill`,`none`),n.setAttribute(`stroke`,`currentColor`),n.setAttribute(`aria-hidden`,`true`),n.innerHTML=t,this.#t.appendChild(n)}#a(e){let t=Oe(e);this.style.setProperty(`--icon-size`,`${t}px`)}#o(e){let t=e||`currentColor`;this.style.setProperty(`--icon-color`,t)}#s(){let e=this.#n.assignedElements({flatten:!0}),t=e.length>0;this.#t.hidden=t,t&&e.forEach(e=>{e.setAttribute(`aria-hidden`,`true`),e.tagName?.toLowerCase()===`svg`&&!e.hasAttribute(`viewBox`)&&console.warn(`[ui-icon] SVG customizado sem atributo viewBox pode não escalar corretamente.`)}),this.dispatchEvent(new CustomEvent(`ui-icon:slotchange`,{detail:{hasSlotContent:t},bubbles:!0,composed:!0}))}};customElements.define(`ui-icon`,Ne);var Pe=[`top`,`bottom`,`left`,`right`],Fe=new CSSStyleSheet;Fe.replaceSync(`
  :host {
    position: fixed;
    z-index: 10001;
    max-width: 320px;
...
`;var Be=class extends HTMLElement{#e;#t;#n;#r=null;static observedAttributes=[`trigger`,`placement`,`tooltip`,`tooltip-ref`,`variant`,`delay`,`offset`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.adoptedStyleSheets=[V],this.#e.appendChild(ze.content.cloneNode(!0)),this.#t=this.#e.querySelector(`slot[name="target"]`),this.#n=this.#e.querySelector(`slot[name="content"]`)}connectedCallback(){this.#t.addEventListener(`slotchange`,()=>this.#i()),this.#i()}disconnectedCallback(){this.#r?.destroy()}attributeChangedCallback(e,t,n){t===n||!this.#r||([`tooltip`,`tooltip-ref`,`variant`].includes(e)?this.#r.updateConfig(this.#a()):this.#i())}#i(){let e=this.#t.assignedElements({flatten:!0});if(!e.length)return;this.#r?.destroy();let t=e[0];this.#r=new Re(t,this.#a())}#a(){let e=this.#n.assignedNodes({flatten:!0}),t=e.length>0?this.#o(e):void 0;return{text:this.getAttribute(`tooltip`)||void 0,templateRef:this.getAttribute(`tooltip-ref`)||void 0,contentSlot:t,placement:this.getAttribute(`placement`)||`top`,variant:this.getAttribute(`variant`)||void 0,delay:Number(this.getAttribute(`delay`)||200),offset:Number(this.getAttribute(`offset`)||8),triggers:(this.getAttribute(`trigger`)||`hover focus`).split(/\s+/)}}#o(e){let t=document.createDocumentFragment(),n=document.createElement(`div`),r=e=>{if(e.nodeType===Node.TEXT_NODE)return e.cloneNode(!1);if(e.nodeType===Node.ELEMENT_NODE){let t=e,n=document.createElement(t.nodeName.toLowerCase());for(let e of Array.from(t.attributes))n.setAttribute(e.name,e.value);for(let e of Array.from(t.childNodes))n.appendChild(r(e));return n}return e.cloneNode(!1)};e.forEach(e=>{n.appendChild(r(e))});let i=n.querySelector(`[class*="tooltip-header"], [class*="header"]`);return i&&i.classList.add(`tooltip-header`),n.querySelectorAll(`[class*="section-title"], [class*="title"]`).forEach(e=>{e.classList.add(`section-title`)}),n.querySelectorAll(`[class*="grid"]`).forEach(e=>{e.classList.add(`controls-grid`)}),n.querySelectorAll(`kbd, [class*="kbd"]`).forEach(e=>{e.classList.add(`kbd`)}),n.querySelectorAll(`[class*="desc"], [class*="text-muted"]`).forEach(e=>{e.classList.contains(`section-title`)||e.classList.add(`control-desc`)}),n.querySelectorAll(`[class*="note"], [class*="math"]`).forEach(e=>{e.classList.add(`math-note`)}),n.querySelectorAll(`[class*="mb-"], [class*="section"]`).forEach(e=>{e.classList.add(`tooltip-section`)}),t.appendChild(n),t}open(){this.#r?.open()}close(){this.#r?.close()}get isOpen(){return this.#r?.[`#isOpen`]??!1}};customElements.define(`ui-tooltip`,Be);function H(e){if(!e)return``;let t=document.createElement(`p`);return t.textContent=e,t.innerHTML}var Ve=e({UIKeyboardShortcuts:()=>U}),U=class e extends HTMLElement{static shortcutsData=[];searchQuery=``;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}static renderShortcut(t,n=`default`){if(!this.shortcutsData.length)return null;let r=t.toLowerCase(),i=this.shortcutsData.find(e=>e.key&&e.key.toLowerCase()===r||e.sequence&&e.sequence.toLowerCase()===r);return i?{html:new e().formatKey(i.sequence||i.key,i.type),description:i.description}:null}set data(t){e.shortcutsData=t,this.render()}get shortcuts(){return e.shortcutsData}get variant(){return this.getAttribute(`variant`)||`default`}get categoryFilter(){return this.getAttribute(`category-filter`)}get enableSearch(){return this.hasAttribute(`enable-search`)&&this.getAttribute(`enable-search`)!==`false`}connectedCallback(){this.render(),this.setupEvents()}setupEvents(){this.shadowRoot?.addEventListener(`input`,e=>{let t=e.target;t.id===`search-input`&&(this.searchQuery=t.value.toLowerCase(),this.renderShortcuts())})}formatKey(e,t){let n=t===`sequence`?e.split(` → `):e.split(`+`),r={arrowup:`↑`,arrowdown:`↓`,arrowleft:`←`,arrowright:`→`,escape:`Esc`,delete:`Del`,backspace:`⌫`,shift:`Shift`,ctrl:`Ctrl`,alt:`Alt`},i=n.map(e=>{let t=e.toLowerCase();return`<kbd class="kbd-prism">${r[t]||(t.length===1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1))}</kbd>`});return t===`longpress`?`${i[0]} <span class="font-mono text-[8px] text-accent-primary uppercase tracking-widest ml-1.5 opacity-80 border border-accent-primary/30 px-1 py-px rounded bg-accent-primary/10">Segure</span>`:t===`sequence`?i.join(`<span class="text-text-muted/50 mx-1 text-[10px]">→</span>`):i.join(`<span class="text-text-muted/50 mx-1 text-[10px]">+</span>`)}getDescription(e){return e.description?e.description:{delete:`Excluir Seleção`,backspace:`Apagar Elemento`}[(e.key||e.sequence||``).toLowerCase()]||`Ação Desconhecida`}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
    ...
    `,this.renderShortcuts())}renderShortcuts(){let e=this.shadowRoot?.getElementById(`shortcuts-wrapper`);if(!e)return;let t=this.shortcuts;if(this.searchQuery&&(t=t.filter(e=>this.getDescription(e).toLowerCase().includes(this.searchQuery)||(e.key||e.sequence||``).toLowerCase().includes(this.searchQuery))),this.categoryFilter&&(t=t.filter(e=>e.category.toLowerCase()===this.categoryFilter?.toLowerCase())),t.length===0){e.innerHTML=`<div class="text-center text-text-muted text-xs py-4 font-mono">Nenhum atalho encontrado.</div>`;return}if(this.variant===`slim`){e.innerHTML=t.map(e=>`
        <div class="flex items-center gap-3 p-1.5 hover:bg-white/5 rounded transition-colors">
          ...
          <span class="text-[11px] text-text-muted truncate">${H(this.getDescription(e))}</span>
        </div>
          ...
          <div class="flex flex-col gap-3.5">
            ${t.map(e=>`
              <div class="flex items-center text-[12px] group">
                <span class="text-text-main group-hover:text-white transition-colors">${H(this.getDescription(e))}</span>
      ...
      `;e.innerHTML=r}};customElements.define(`ui-keyboard-shortcuts`,U);var He=class extends HTMLElement{unsubscribe=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}connectedCallback(){this.render(),this.setupListeners(),this.updateUI()}disconnectedCallback(){this.unsubscribe&&this.unsubscribe()}setupListeners(){this.unsubscribe=r.on(`state:change`,e=>{this.updateUI(e)}),r.on(`command:toolbar:upload-image`,()=>{this.shadowRoot?.getElementById(`file-input`)?.click()})}updateUI(e=C.getState()){let t=this.shadowRoot;if(!t)return;let n=t.getElementById(`undo`),r=t.getElementById(`redo`);n&&n.toggleAttribute(`disabled`,!e.canUndo),r&&r.toggleAttribute(`disabled`,!e.canRedo)}getShortcutHTML(e){let t=U.renderShortcut(e);return t?t.html:`<kbd class="kbd-prism">${e}</kbd>`}render(){!this.shadowRoot||this.shadowRoot.querySelector(`#add-text`)||(this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
          align-items: center;
    ...
    `,this.attachEvents())}attachEvents(){let e=this.shadowRoot,t=e.getElementById(`file-input`);e.getElementById(`add-text`)?.addEventListener(`click`,()=>{r.emit(`element:add`,R.create(u.TEXT))}),e.getElementById(`add-rect`)?.addEventListener(`click`,()=>{r.emit(`element:add`,R.create(u.RECTANGLE))}),e.getElementById(`add-border`)?.addEventListener(`click`,()=>{r.emit(`element:add`,R.create(u.BORDER))}),e.getElementById(`add-image`)?.addEventListener(`click`,()=>t.click()),t?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(!t)return;let{imageProcessor:n}=await S(async()=>{let{imageProcessor:e}=await import(`./imageProcessor-hb43SnrL.js`);return{imageProcessor:e}},__vite__mapDeps([4,3,2]),import.meta.url),i=await n.process(t),a=C.getState().currentLabel.config;r.emit(`element:add`,R.create(u.IMAGE,{dimensions:{width:N.pxToMm(i.width,a.dpi),height:N.pxToMm(i.height,a.dpi)},src:i.src}))}),e.getElementById(`open-help`)?.addEventListener(`click`,()=>{r.emit(`ui:open:help`,{tab:`guide`});let t=e.getElementById(`open-help`);t&&t.classList.remove(`pulse-help`)}),e.getElementById(`undo`)?.addEventListener(`click`,()=>r.emit(`history:undo`,{source:`toolbar`})),e.getElementById(`redo`)?.addEventListener(`click`,()=>r.emit(`history:redo`,{source:`toolbar`})),e.getElementById(`save`)?.addEventListener(`click`,async()=>{let{templateManager:e}=await S(async()=>{let{templateManager:e}=await Promise.resolve().then(()=>te);return{templateManager:e}},void 0,import.meta.url);await e.saveCurrentLabel(),r.emit(`notify`,{type:`success`,message:`Template salvo com sucesso!`})}),e.getElementById(`open-batch`)?.addEventListener(`click`,()=>{let e=document.getElementById(`batch-modal`);e&&e.setAttribute(`open`,``),g.play(g.enumPresets.OPEN)}),e.getElementById(`open-project-modal`)?.addEventListener(`click`,()=>{let e=document.getElementById(`project-modal`);e&&e.setAttribute(`open`,``),g.play(g.enumPresets.OPEN)}),document.getElementById(`btn-export-file`)?.addEventListener(`click`,async()=>{await z.exportToFile(),g.play(g.enumPresets.SUCCESS)}),document.getElementById(`btn-import-trigger`)?.addEventListener(`click`,()=>{document.getElementById(`global-import-input`)?.click()}),document.getElementById(`global-import-input`)?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t)try{await z.importFromFile(t);let e=document.getElementById(`project-modal`);e&&e.removeAttribute(`open`),g.play(g.enumPresets.SUCCESS),r.emit(`notify`,{message:`Projeto importado com sucesso!`,type:`success`})}catch(e){r.emit(`notify`,{message:`Erro ao importar: `+e.message,type:`error`})}})}};customElements.define(`editor-toolbar`,He);function Ue(e,t=300){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)}}function We(e,{includeTime:t=!1,isRelative:n=!1,locale:r=`pt-BR`}={}){if(!e)throw Error(`isoString é obrigatório`);let i=new Date(e);if(isNaN(i.getTime()))throw Error(`Data inválida`);if(n){let e=Math.floor((i.getTime()-Date.now())/1e3),t=new Intl.RelativeTimeFormat(r,{numeric:`auto`});for(let[n,r]of[[31536e3,`year`],[2592e3,`month`],[86400,`day`],[3600,`hour`],[60,`minute`],[1,`second`]]){let i=Math.trunc(e/n);if(Math.abs(i)>=1)return t.format(i,r)}return t.format(0,`second`)}let a={day:`2-digit`,month:`2-digit`,year:`numeric`};return t&&Object.assign(a,{hour:`2-digit`,minute:`2-digit`,hour12:!1}),new Intl.DateTimeFormat(r,a).format(i)}var Ge={transform:{title:`Transform Settings`,icon:`maximize`,commands:[{key:`Shift`,label:`Drag`,desc:`Salto rápido (±10mm)`},{key:`Alt`,label:`Drag`,desc:`Ajuste fino (±0.1mm)`}],proTip:{icon:`calculator`,text:`Inputs aceitam matemática.</br>Ex: <code class="text-accent-primary/80">100/2 + 15</code>`,isSuccess:!1}},text:{title:`Typography Pro`,icon:`text`,commands:[{label:`Scale`,desc:`Ajusta fonte para caber na caixa.`},{label:`Wrap`,desc:`Quebra texto em múltiplas linhas.`},{label:`Lead`,desc:`Espaçamento entre linhas (multiplicador).`},{label:`Justify`,desc:`Distribui o texto entre as bordas.`}],proTip:{icon:`brackets`,text:`Formatadores: <code class="text-accent-primary/80">:upper</code>, <code class="text-accent-primary/80">:currency</code>, <code class="text-accent-primary/80">:date</code>. Ex: <code class="text-accent-primary/80">{{valor:currency}}</code>`,isSuccess:!1}},rect:{title:`Shape Properties`,icon:`rect`,commands:[{label:`Radius`,desc:`Arredonda os cantos da forma.`},{label:`Stroke`,desc:`Espessura do contorno externo.`}],proTip:{icon:`lightbulb`,text:`Defina cor de preenchimento como transparente se desejar apenas o contorno.`,isSuccess:!1}},image:{title:`Image Intelligence`,icon:`image`,commands:[{label:`Cover`,desc:`Preenche a área cortando as sobras.`},{label:`Contain`,desc:`Ajusta a imagem sem realizar cortes.`},{label:`Blend`,desc:`Mescla a imagem com as camadas inferiores.`}],proTip:{icon:`sparkles`,text:`Desative "Smoothing" para códigos de barras ou pixel art nítidos.`,isSuccess:!1}},border:{title:`Frame Decoration`,icon:`blocks`,commands:[{label:`Inset`,desc:`Recuo da moldura em relação ao canvas.`},{label:`Double`,desc:`Cria uma moldura concêntrica dupla.`}],proTip:{icon:`pencil-ruler`,text:`O raio da borda interna é calculado para ser harmônico com a externa.`,isSuccess:!1}},setup:{title:`Document Setup`,icon:`settings`,commands:[{label:`Presets`,desc:`Tamanhos de etiquetas do mercado.`},{label:`DPI`,desc:`Resolução (300 para impressão).`},{label:`Bleed`,desc:`Sangria para evitar bordas brancas.`}],proTip:{icon:`database`,text:` Designs são salvos localmente em tempo real.`,isSuccess:!1}},global:{title:`Technical Guide`,icon:`cpu`,commands:[{key:`Shift`,label:`Drag`,desc:`Salto rápido (±10mm)`},{key:`Alt`,label:`Drag`,desc:`Ajuste fino (±0.1mm)`},{label:`Math`,desc:`Aceita fórmulas (ex: 100/2 + 5)`}],proTip:{icon:`keyboard`,text:`Pressione <kbd class="kbd-prism">Ctrl</kbd>+<kbd class="kbd-prism">/</kbd> para ver todos os atalhos.`,isSuccess:!1}}},W=class{static buildTooltip(e,t=`left`){let n=Ge[e];if(!n)return``;let r=n.commands.map(e=>`
    ...
    `).join(``),i=n.proTip?.isSuccess?`text-accent-success`:`text-accent-primary`,a=n.proTip?`
      <div class="mt-3 pt-2 border-t border-white/5 flex gap-2 items-start text-[10px]">
        <ui-icon name="${n.proTip.icon}" class="w-3.5 h-3.5 ${i} shrink-0 mt-0.5"></ui-icon>
      ...
      <ui-tooltip placement="${t}" delay="200">
        ...
        <div slot="content" class="tooltip-rich-panel w-65">
          <div class="tooltip-rich-header">
            <ui-icon name="${n.icon}" class="w-3.5 h-3.5 text-accent-primary cursor-help"></ui-icon>
    ...
    `}};customElements.define(`app-select`,Xe);var Ze=class extends HTMLElement{_labelConfig=null;_preferences=null;_thumbnailUrl=``;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set labelConfig(e){this._labelConfig=e,this.syncValues()}set preferences(e){this._preferences=e,this.syncValues()}set thumbnailUrl(e){this._thumbnailUrl=e,this.syncDigitalTwin()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues(),this.syncDigitalTwin()}render(){if(!this.shadowRoot||!this._labelConfig||!this._preferences)return;let{widthMM:e,heightMM:t,backgroundColor:n,dpi:r,previewScale:i}=this._labelConfig,a=this._preferences;this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="row-ui">
        ...
        <app-input label="Paper" type="color" data-prop="doc.backgroundColor" value="${H(n||`#ffffff`)}" class="fixed-small"></app-input>
      </div>
      <div class="row-ui">
      ...
      <div class="card-module" style="padding: 12px; display: flex; flex-direction: column; gap: 10px;">
        ...
        <div class="flex justify-between items-center">
          ...
          <ui-number-scrubber data-prop="pref.gridSizeMM" value="${a.gridSizeMM}" min="1" max="50" step="1" unit="mm" style="width: 80px; flex: none;"></ui-number-scrubber>
        </div>
        <div class="flex justify-between items-center">
    ...
    `;let o=this.shadowRoot.getElementById(`select-preset`);o&&(o.options=l)}setupListeners(){let e=this.shadowRoot,t=t=>{let n=t.target.getAttribute(`data-prop`);if(n===`doc.widthMM`||n===`doc.heightMM`){let t=e.getElementById(`select-preset`);t&&(t.value=`custom`)}if(!n)return;let r=q(t);r!==void 0&&G(this,{prop:n,value:r})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t),e.getElementById(`select-preset`)?.addEventListener(`app-select`,e=>{let t=e.detail,n=l.find(e=>e.value===t);n&&n.value!==`custom`&&(G(this,{prop:`doc.widthMM`,value:n.w}),G(this,{prop:`doc.heightMM`,value:n.h}))}),e.getElementById(`btn-open-vault`)?.addEventListener(`click`,()=>{K(this,{action:`open-vault`})})}syncValues(){if(!this.shadowRoot||!this._labelConfig||!this._preferences)return;let e=this.shadowRoot,t=this._labelConfig,n=this._preferences,r=e.getElementById(`select-preset`);if(r){let e=l.find(e=>e.w===t.widthMM&&e.h===t.heightMM),n=e?e.value:`custom`;r.value!==n&&(r.value=n)}e.querySelectorAll(`[data-prop]`).forEach(r=>{let i=r.getAttribute(`data-prop`);if(!i)return;let a=r instanceof HTMLInputElement&&r.type===`checkbox`;if(!((e.activeElement===r||r.shadowRoot?.activeElement)&&!a))if(i===`doc.widthMM`)r.value!=t.widthMM&&(r.value=t.widthMM);else if(i===`doc.heightMM`)r.value!=t.heightMM&&(r.value=t.heightMM);else if(i===`doc.dpi`)r.value!=t.dpi&&(r.value=t.dpi);else if(i===`doc.previewScale`)r.value!=t.previewScale&&(r.value=t.previewScale);else if(i===`doc.backgroundColor`){let e=t.backgroundColor||`#ffffff`;r.value!=e&&(r.value=e)}else i===`pref.audioEnabled`?r.checked!==n.audioEnabled&&(r.checked=n.audioEnabled):i===`pref.showGrid`?r.checked!==n.showGrid&&(r.checked=n.showGrid):i===`pref.gridSizeMM`?r.value!=n.gridSizeMM&&(r.value=n.gridSizeMM):i===`pref.unit`&&r instanceof HTMLSelectElement&&r.value!==n.unit&&(r.value=n.unit)})}syncDigitalTwin(){let e=this.shadowRoot?.getElementById(`monitor-img`);e&&(e.src=this._thumbnailUrl)}};customElements.define(`inspector-document-setup`,Ze);function J(e){return`dimensions`in e}var Qe=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){this._element=e,this.syncValues()}get element(){return this._element}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element,t=e.keepRatio===!0;this.shadowRoot.innerHTML=`
      <style>
    ...
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);if(n!=null){if(this._element&&this._element.keepRatio&&J(this._element)){let e=this._element,r=e.dimensions.width,i=e.dimensions.height,a=i===0?1:r/i;if(t===`dimensions.width`){let e=Number(n),t=Number((e/a).toFixed(2));G(this,{prop:`dimensions`,value:{width:e,height:t}});return}if(t===`dimensions.height`){let e=Number(n),t=Number((e*a).toFixed(2));G(this,{prop:`dimensions`,value:{width:t,height:e}});return}}G(this,{prop:t,value:n})}};e.addEventListener(`input`,t),e.addEventListener(`change`,t),e.addEventListener(`app-input`,t),e.getElementById(`btn-toggle-ratio`)?.addEventListener(`click`,()=>{if(!this._element)return;let e=!this._element.keepRatio;G(this,{prop:`keepRatio`,value:e}),g.play(g.enumPresets.TOGGLE)})}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot,n=t.getElementById(`btn-toggle-ratio`),r=t.querySelector(`.ratio-link-container`);if(n&&r){let t=e.keepRatio===!0;n.classList.toggle(`active`,t),r.classList.toggle(`active`,t),n.setAttribute(`title`,t?`Unlock Aspect Ratio`:`Lock Aspect Ratio`)}t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r)return;let i=t.activeElement===n||n.shadowRoot?.activeElement,a=n.classList.contains(`is-scrubbing`);if(!i&&!a){let t;r===`position.x`?t=e.position.x:r===`position.y`?t=e.position.y:r===`rotation`?t=e.rotation:r===`opacity`?t=e.opacity:r===`dimensions.width`&&J(e)?t=e.dimensions.width:r===`dimensions.height`&&J(e)&&(t=e.dimensions.height);let i=n.value===void 0?n.getAttribute(`value`):n.value;t!==void 0&&String(i)!==String(t)&&(n.value=t,n.setAttribute(`value`,String(t)))}})}};customElements.define(`inspector-section-transform`,Qe);var $e=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element,t=e.overflow===s.SCALE;this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="row-ui">
        <app-input label="Content" data-prop="content" value="${H(e.content)}" style="flex:1"></app-input>
      </div>
      ...
      <div class="row-ui">
        ...
        <app-input label="Color" type="color" data-prop="color" value="${H(e.color)}" class="fixed-small"></app-input>
      </div>
    ...
    `,this.setupSelects()}setupSelects(){let e=this.shadowRoot,t=e.getElementById(`font-family`);t&&(t.options=[{value:`Inter`,label:`Inter`,sublabel:`Sans-Serif (Default)`},{value:`JetBrains Mono`,label:`JetBrains Mono`,sublabel:`Monospace (Data)`},{value:`Arial`,label:`Arial`,sublabel:`System`},{value:`Times New Roman`,label:`Times New Roman`,sublabel:`Serif`},{value:`Geist`,label:`Geist`,sublabel:`Modern Sans`}]);let n=e.getElementById(`font-weight`);n&&(n.options=[{value:`100`,label:`Thin`},{value:`300`,label:`Light`},{value:`400`,label:`Normal`},{value:`500`,label:`Medium`},{value:`600`,label:`Semi Bold`},{value:`700`,label:`Bold`},{value:`900`,label:`Black`}]);let r=e.getElementById(`font-style`);r&&(r.options=[{value:`normal`,label:`Normal`},{value:`italic`,label:`Italic`}]);let i=e.getElementById(`text-align`);i&&(i.options=[{value:`left`,label:`Left`,sublabel:`Flush start`},{value:`center`,label:`Center`,sublabel:`Middle alignment`},{value:`right`,label:`Right`,sublabel:`Flush end`}]);let a=e.getElementById(`vertical-align`);a&&(a.options=[{value:`top`,label:`Top`,sublabel:`Anchor ceiling`},{value:`middle`,label:`Middle`,sublabel:`Anchor center`},{value:`bottom`,label:`Bottom`,sublabel:`Anchor floor`}]);let o=e.getElementById(`text-overflow`);o&&(o.options=[{value:s.WRAP,label:`Wrap`,sublabel:`Multi-line break`},{value:s.CLIP,label:`Clip`,sublabel:`Hard cut content`},{value:s.ELLIPSIS,label:`Ellipsis`,sublabel:`Add "..." at end`},{value:s.SCALE,label:`Scale to Fit`,sublabel:`Auto-shrink font`}])}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`app-select`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot,n=e.overflow===s.SCALE,r=t.getElementById(`font-size-scrubber`);r&&(n?r.setAttribute(`disabled`,``):r.removeAttribute(`disabled`)),t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;if(r===`content`?i=e.content:r===`fontSize`?i=e.fontSize:r===`lineHeight`?i=e.lineHeight:r===`color`?i=e.color:r===`fontWeight`?i=String(e.fontWeight):r===`fontStyle`?i=e.fontStyle:r===`justify`?i=e.justify:r===`fontFamily`?i=e.fontFamily:r===`textAlign`?i=e.textAlign:r===`verticalAlign`?i=e.verticalAlign:r===`overflow`&&(i=e.overflow),n instanceof HTMLInputElement&&n.type===`checkbox`)n.checked!==!!i&&(n.checked=!!i);else{let e=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&String(e)!==String(i)&&(n.value=i,n.setAttribute(`value`,String(i)))}})}};customElements.define(`inspector-section-text`,$e);var et=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      ...
      <div class="row-ui">
        <app-input label="Fill" type="color" data-prop="fillColor" value="${H(e.fillColor)}" style="flex:1"></app-input>
        <app-input label="Stroke" type="color" data-prop="strokeColor" value="${H(e.strokeColor)}" style="flex:1"></app-input>
      </div>
      <div class="row-ui">
    ...
    `}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;r===`fillColor`?i=e.fillColor:r===`strokeColor`?i=e.strokeColor:r===`borderRadius`?i=e.borderRadius:r===`strokeWidth`&&(i=e.strokeWidth);let a=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&a!=i&&(n.value=i,n.setAttribute(`value`,String(i)))})}};customElements.define(`inspector-section-rect`,et);var tt=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){this._element=e,this.syncValues()}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      <style>
        :host { display: flex; flex-direction: column; gap: 8px; padding-bottom: 16px; }
        .row-ui { display: flex; gap: 10px; align-items: flex-end; }
        .row-ui > * { flex: 1; min-width: 0; }
      ...
      <div class="row-ui">
        <app-select id="blend-mode" label="Blending" data-prop="compositeOperation" value="${e.compositeOperation||o.SOURCE_OVER}"></app-select>
      </div>
    ...
    `,this.setupSelects()}setupSelects(){let e=this.shadowRoot,t=e.getElementById(`fit-mode`);t&&(t.options=[{value:f.CONTAIN,label:`Contain`,sublabel:`Fit inside box`},{value:f.COVER,label:`Cover`,sublabel:`Fill and crop`},{value:f.FILL,label:`Stretch`,sublabel:`Distort to fill`},{value:f.NONE,label:`Original`,sublabel:`No scaling`}]);let n=e.getElementById(`blend-mode`);n&&(n.options=[{value:o.SOURCE_OVER,label:`Normal`,sublabel:`Standard overlay`},{value:o.MULTIPLY,label:`Multiply`,sublabel:`Darken interaction`},{value:o.SCREEN,label:`Screen`,sublabel:`Lighten interaction`},{value:o.OVERLAY,label:`Overlay`,sublabel:`High contrast`},{value:o.DARKEN,label:`Darken`,sublabel:`Keep darkest pixels`},{value:o.LIGHTEN,label:`Lighten`,sublabel:`Keep lightest pixels`},{value:o.COLOR_DODGE,label:`Color Dodge`,sublabel:`Brighten pixels`},{value:o.COLOR_BURN,label:`Color Burn`,sublabel:`Darken with contrast`},{value:o.HARD_LIGHT,label:`Hard Light`,sublabel:`Sharp contrast`},{value:o.SOFT_LIGHT,label:`Soft Light`,sublabel:`Subtle contrast`},{value:o.DIFFERENCE,label:`Difference`,sublabel:`Invert differences`},{value:o.EXCLUSION,label:`Exclusion`,sublabel:`Lower contrast diff`}])}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);n!=null&&G(this,{prop:t,value:n})};e.addEventListener(`app-input`,t),e.addEventListener(`app-select`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;if(r===`fit`?i=e.fit:r===`compositeOperation`?i=e.compositeOperation||o.SOURCE_OVER:r===`smoothing`&&(i=e.smoothing!==!1),n instanceof HTMLInputElement&&n.type===`checkbox`)n.checked!==!!i&&(n.checked=!!i);else{let e=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&String(e)!==String(i)&&(n.value=i,n.setAttribute(`value`,String(i)))}})}};customElements.define(`inspector-section-image`,tt);var nt=class extends HTMLElement{_element=null;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){this._element=e,this.syncValues()}get element(){return this._element}connectedCallback(){this.render(),this.setupListeners(),this.syncValues()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element;this.shadowRoot.innerHTML=`
      <style>
        :host { display: flex; flex-direction: column; gap: 8px; padding-bottom: 16px; }
        .row-ui { display: flex; gap: 10px; align-items: flex-end; }
        .row-ui > * { flex: 1; min-width: 0; }
      ...
      <div class="row-ui">
        <app-input label="Color" type="color" data-prop="color" value="${H(e.color)}" style="flex: 1"></app-input>
    ...
    `,this.setupSelects()}setupSelects(){let e=this.shadowRoot.getElementById(`border-style`);e&&(e.options=[{value:c.SOLID,label:`Solid`,sublabel:`Continuous line`},{value:c.DASHED,label:`Dashed`,sublabel:`Long dashes`},{value:c.DOTTED,label:`Dotted`,sublabel:`Round dots`},{value:c.DOUBLE,label:`Double`,sublabel:`Two parallel lines`}])}setupListeners(){let e=this.shadowRoot,t=e=>{let t=e.target.getAttribute(`data-prop`);if(!t)return;let n=q(e);if(n!=null){if(t===`position.x`){G(this,{prop:`position`,value:{x:Number(n),y:Number(n)}});return}G(this,{prop:t,value:n})}};e.addEventListener(`app-input`,t),e.addEventListener(`app-select`,t),e.addEventListener(`input`,t),e.addEventListener(`change`,t)}syncValues(){if(!this._element||!this.shadowRoot)return;let e=this._element,t=this.shadowRoot;t.querySelectorAll(`[data-prop]`).forEach(n=>{let r=n.getAttribute(`data-prop`);if(!r||t.activeElement===n||n.shadowRoot?.activeElement)return;let i;r===`style`?i=e.style:r===`color`?i=e.color:r===`width`?i=e.width:r===`radius`?i=e.radius:r===`position.x`&&(i=e.position.x);let a=n.value===void 0?n.getAttribute(`value`):n.value;i!==void 0&&String(a)!==String(i)&&(n.value=i,n.setAttribute(`value`,String(i)))})}};customElements.define(`inspector-section-border`,nt);var rt=class extends HTMLElement{_element=null;_selected=!1;_hasOverflow=!1;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}set element(e){let t=this._element?.id,n=this._element?.locked;this._element=e,t===e.id?(this.updateHeader(),this.syncSections(),n!==e.locked&&this.updateLockState()):this.render()}get element(){return this._element}set selected(e){this._selected!==e&&(this._selected=e,this.render())}set hasOverflow(e){this._hasOverflow=e,this.updateWarningTag()}connectedCallback(){this.render()}render(){if(!this.shadowRoot||!this._element)return;let e=this._element,t=H(e.id),n=this._selected,r=e.locked===!0;this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="element-card ${n?`selected`:``} ${r?`is-locked`:``}" data-id="${t}">
        <div class="card-header" id="header-select" style="cursor: pointer;">
          <span class="type-tag">${H(e.type)}</span>
          <span class="layer-name" id="label-name">${H(e.name||e.type)}</span>
    ...
    `,this.setupListeners(),n&&this.renderSections()}setupListeners(){let e=this.shadowRoot,t=this._element?.id;if(t&&(e.getElementById(`header-select`)?.addEventListener(`click`,e=>{e.target.closest(`.action-btn`)||K(this,{action:`select`,id:t})}),e.getElementById(`btn-toggle-vis`)?.addEventListener(`click`,e=>{e.stopPropagation(),K(this,{action:`toggle-vis`,id:t})}),e.getElementById(`btn-toggle-lock`)?.addEventListener(`click`,e=>{e.stopPropagation(),K(this,{action:`toggle-lock`,id:t})}),e.addEventListener(`ui-select:open`,()=>{this.classList.add(`elevated`)}),e.addEventListener(`ui-select:close`,()=>{this.classList.remove(`elevated`)}),this._selected)){let n=e.getElementById(`sections-container`);n.addEventListener(`app-input`,e=>{if(this._element?.locked)return;let t=e.target.getAttribute(`data-prop`);if(t===`name`){let n=e.detail,r=typeof n==`object`&&n&&`value`in n?n.value:n;r!==void 0&&G(this,{prop:t,value:r})}}),n.addEventListener(`click`,e=>{if(this._element?.locked)return;let n=e.target.closest(`[data-card-action]`);if(n){let e=n.getAttribute(`data-card-action`);K(this,{action:e,id:t})}})}}renderSections(){let e=this.shadowRoot?.getElementById(`sections-container`);if(!e||!this._element)return;let t=this._element,n=document.createElement(`div`);n.innerHTML=`
      <span class="label-prism">Identification</span>
      <div class="row-ui">
        <app-input label="Layer Name" data-prop="name" value="${H(this._element.name||``)}" style="flex:1"></app-input>
      </div>
    `,e.appendChild(n);let r=e=>{let n=document.createElement(e);return n.setAttribute(`data-inspector-section`,``),n.element=t,n};e.appendChild(r(`inspector-section-transform`)),t.type===u.TEXT?e.appendChild(r(`inspector-section-text`)):t.type===u.RECTANGLE?e.appendChild(r(`inspector-section-rect`)):t.type===u.IMAGE?e.appendChild(r(`inspector-section-image`)):t.type===u.BORDER&&e.appendChild(r(`inspector-section-border`));let i=document.createElement(`div`);i.style.marginTop=`16px`,i.style.display=`flex`,i.style.gap=`8px`,i.innerHTML=`
    ...
    `,e.appendChild(i),this.syncSections()}updateHeader(){if(!this.shadowRoot||!this._element)return;let e=this._element,t=this.shadowRoot.getElementById(`label-name`);t&&(t.textContent=e.name||e.type);let n=this.shadowRoot.getElementById(`btn-toggle-vis`),r=n?.querySelector(`ui-icon`);r&&(r.setAttribute(`name`,e.visible===!1?`eye`:`eye-off`),r.style.opacity=e.visible===!1?`0.4`:`1`,n?.classList.toggle(`active`,e.visible!==!1));let i=this.shadowRoot.getElementById(`btn-toggle-lock`),a=i?.querySelector(`ui-icon`),o=e.locked===!0;a&&(a.setAttribute(`name`,o?`lock`:`unlock`),a.style.opacity=o?`1`:`0.4`,i?.classList.toggle(`active`,o),i?.classList.toggle(`warning`,o)),this.updateWarningTag()}updateLockState(){if(!this.shadowRoot||!this._element)return;let e=this._element.locked===!0;this.shadowRoot.querySelector(`.element-card`)?.classList.toggle(`is-locked`,e)}updateWarningTag(){let e=this.shadowRoot?.getElementById(`warning-tag`);e&&(e.style.display=this._hasOverflow?`inline`:`none`)}syncSections(){if(!this._selected||!this.shadowRoot||!this._element)return;let e=this._element,t=this.shadowRoot,n=t.querySelector(`[data-prop="name"]`);n&&t.activeElement!==n&&!n.shadowRoot?.activeElement&&(n.value=e.name||``,n.setAttribute(`value`,e.name||``)),t.querySelectorAll(`[data-inspector-section]`).forEach(t=>{t.element=e})}};customElements.define(`inspector-layer-card`,rt);var it=class extends HTMLElement{abortController=null;currentElementsJson=``;currentSelectedId=null;currentThumbnail=``;overflowWarnings=new Map;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}connectedCallback(){this.renderSkeleton(),this.setupListeners(),this.handleStateChange(C.getState())}disconnectedCallback(){this.cleanup()}cleanup(){this.abortController&&=(this.abortController.abort(),null)}setupListeners(){this.cleanup(),this.abortController=new AbortController;let{signal:e}=this.abortController;r.on(`state:change`,e=>this.handleStateChange(e),{signal:e}),r.on(`element:warning`,({id:e,result:t})=>{this.overflowWarnings.set(e,t),this.syncOverflowStatus()},{signal:e}),r.on(`element:warning:clear`,({id:e})=>{this.overflowWarnings.delete(e),this.syncOverflowStatus()},{signal:e});let t=this.shadowRoot;t.addEventListener(Je,e=>this.onInspectorChange(e),{signal:e}),t.addEventListener(Ye,e=>this.onInspectorAction(e),{signal:e})}handleStateChange(e){let t=e.currentLabel;if(!t)return;let n=t.elements,r=e.selectedElementIds[0]||null,i=JSON.stringify(n.map(e=>({id:e.id,v:e.visible})));i!==this.currentElementsJson||r!==this.currentSelectedId?(this.currentElementsJson=i,this.currentSelectedId=r,this.rebuildPanel(t,e)):this.syncValues(t,e),this.updateDigitalTwin(t)}renderSkeleton(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
      ...
      <div class="inspector-header">
        ...
        ${W.buildTooltip(`global`,`bottom`)}
      </div>
      <div id="panel-content"></div>
    `)}rebuildPanel(e,t){let n=this.shadowRoot?.getElementById(`panel-content`),r=this.shadowRoot?.getElementById(`panel-title`),i=this.shadowRoot?.getElementById(`unit-count`);if(!n)return;n.innerHTML=``;let a=this.currentSelectedId;if(a)r&&(r.textContent=`PROPERTIES`),i&&(i.textContent=`${e.elements.length} UNITS`),[...e.elements].sort((e,t)=>t.zIndex-e.zIndex).forEach(e=>{let t=document.createElement(`inspector-layer-card`);t.element=e,t.selected=e.id===a,t.hasOverflow=this.overflowWarnings.has(e.id),n.appendChild(t)});else{r&&(r.textContent=`LABEL SETUP`),i&&(i.textContent=`BLUEPRINT`);let a=document.createElement(`inspector-document-setup`);a.labelConfig=e.config,a.preferences=t.preferences,a.thumbnailUrl=this.currentThumbnail,n.appendChild(a)}}syncValues(e,t){let n=this.shadowRoot;if(this.currentSelectedId)n.querySelectorAll(`inspector-layer-card`).forEach(t=>{let n=e.elements.find(e=>e.id===t.element?.id);n&&(t.element=n,t.hasOverflow=this.overflowWarnings.has(n.id))});else{let r=n.querySelector(`inspector-document-setup`);r&&(r.labelConfig=e.config,r.preferences=t.preferences)}}onInspectorChange(e){let{prop:t,value:n}=e.detail;if(t.startsWith(`doc.`)){let e=C.getState().currentLabel;e&&r.emit(`label:config:update`,{...e.config,[t.replace(`doc.`,``)]:n})}else if(t.startsWith(`pref.`))r.emit(`preferences:update`,{[t.replace(`pref.`,``)]:n});else{let r=e.target.closest(`inspector-layer-card`)?.element?.id||this.currentSelectedId;r&&this.emitElementUpdate(r,t,n)}}onInspectorAction(e){let{action:t,id:n}=e.detail;if(t===`open-vault`){let e=document.getElementById(`vault-modal`);e&&e.setAttribute(`open`,``),g.play(g.enumPresets.OPEN);return}if(n)switch(t){case`select`:n!==this.currentSelectedId&&(r.emit(`element:select`,n),g.play(g.enumPresets.TAP));break;case`toggle-vis`:let e=C.getState().currentLabel?.elements.find(e=>e.id===n);e&&r.emit(`element:update`,{id:n,updates:{visible:e.visible===!1}}),g.play(g.enumPresets.TOGGLE);break;case`toggle-lock`:let t=C.getState().currentLabel?.elements.find(e=>e.id===n);t&&r.emit(`element:update`,{id:n,updates:{locked:!t.locked}}),g.play(g.enumPresets.TOGGLE);break;case`up`:r.emit(`element:reorder`,{id:n,direction:`up`});break;case`del`:r.emit(`element:delete`,n);break}}emitElementUpdate(e,t,n){let i={};if(t.includes(`.`)){let[e,r]=t.split(`.`);i[e]={...i[e]||{},[r]:n}}else i[t]=n;r.emit(`element:update`,{id:e,updates:i})}updateDigitalTwin=Ue(async e=>{if(!e)return;let{templateManager:t}=await S(async()=>{let{templateManager:e}=await Promise.resolve().then(()=>te);return{templateManager:e}},void 0,import.meta.url);this.currentThumbnail=await t.captureThumbnail(e);let n=this.shadowRoot?.querySelector(`inspector-document-setup`);n&&(n.thumbnailUrl=this.currentThumbnail)},1e3);syncOverflowStatus(){(this.shadowRoot?.querySelectorAll(`inspector-layer-card`))?.forEach(e=>{e.element&&(e.hasOverflow=this.overflowWarnings.has(e.element.id))})}};customElements.define(`element-inspector`,it);var at=document.createElement(`template`);at.innerHTML=`
<style>
  :host {
    --uc-z-index: 9999;
...
`;var ot={danger:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    ...
    `,r.onclick=()=>{z.createNewProject(),this.closeVault(),g.play(g.enumPresets.OPEN)},n.appendChild(r),t.forEach(e=>{let t=document.createElement(`div`);t.innerHTML=this.renderCartridgeHtml(e),n.appendChild(t.firstElementChild)}),e.innerHTML=``,e.appendChild(n)}renderCartridgeHtml(e){let t=We(new Date(e.updatedAt).toISOString(),{isRelative:!0}),n=We(new Date(e.updatedAt).toISOString(),{includeTime:!0}),r=e.config.widthMM/e.config.heightMM,i=this.getElementSummary(e);return`
    <div class="group relative bg-surface-solid border border-border-ui rounded-2xl overflow-hidden shadow-panel transition-all duration-300 ease-spring hover:border-accent-primary hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_15px_rgba(99,102,241,0.2)]" data-id="${e.id}">
        ...
        <div class="p-4 bg-surface-solid">
          <div class="flex items-center justify-between gap-2 mb-2.5">
            <h4 class="font-sans text-[13px] font-bold text-text-main truncate group-hover:text-accent-primary transition-colors" title="${H(e.name)}">
              ${H(e.name)}
            </h4>
    ...
    `,this.setupEvents())}renderContent(){switch(this.activeTab){case`guide`:return this.renderGuide();case`shortcuts`:return this.renderShortcuts();case`about`:return this.renderAbout();default:return``}}parseTipWithShortcuts(e){return e.replace(/\[([^\]]+)\]/g,(e,t)=>{let n=U.renderShortcut(t);return n?n.html:`<kbd class="kbd-prism">${t}</kbd>`})}renderGuide(){return`
      <!-- TUTORIAL SECTIONS (Z-Pattern) -->
      <div class="flex flex-col gap-16 mb-16">
        ${Y.tutorialSection.map((e,t)=>`
    ...
    `}renderAbout(){let e=Y.aboutSection;return`
    ...
    `}setupEvents(){let e=this.shadowRoot;if(e.querySelectorAll(`[data-tab]`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.tab;t!==this.activeTab&&(this.activeTab=t,g.play(g.enumPresets.TAP),this.render())})}),this.activeTab===`shortcuts`){let t=e.getElementById(`shortcut-viewer`);t&&(t.data=ae.listShortcuts())}}};customElements.define(`ui-help-center`,ft);var pt=[`default`,`success`,`danger`,`warning`,`info`],mt=[`sm`,`md`,`lg`,`xl`,`fullscreen`],ht=[`fade`,`scale`,`slide`,`flip`],gt={default:{accent:`#6366f1`,fg:`#fff`,icon:null},success:{accent:`#16a34a`,fg:`#fff`,icon:`✓`},danger:{accent:`#dc2626`,fg:`#fff`,icon:`!`},warning:{accent:`#d97706`,fg:`#fff`,icon:`⚠`},info:{accent:`#0284c7`,fg:`#fff`,icon:`i`}},_t={sm:`28rem`,md:`40rem`,lg:`56rem`,xl:`72rem`,fullscreen:`100vw`};function vt(e){return pt.includes(e)}function X(e){return mt.includes(e)}function yt(e){return ht.includes(e)}var bt=`
  :host {
    display: contents;
...
`,St=`a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"]),details>summary`,Ct=class extends HTMLElement{#e;#t;#n=null;#r;#i;#a;#o;#s;#c;#l;#u=!1;#d=!1;#f=null;static observedAttributes=[`variant`,`size`,`animation`,`heading`,`open`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#t=this.attachInternals();let e=new CSSStyleSheet;e.replaceSync(bt),this.#e.adoptedStyleSheets=[e],this.#e.innerHTML=xt,this.#m()}connectedCallback(){if(this.#d)return;this.#d=!0,this.#n=new AbortController;let e=this.#n.signal;this.#a.addEventListener(`click`,()=>this.close(),{signal:e}),this.#r.addEventListener(`click`,e=>{e.target===this.#r&&this.#b()},{signal:e}),this.#l.addEventListener(`slotchange`,()=>{let e=this.#l.assignedNodes({flatten:!0}).length>0;this.#c.classList.toggle(`hidden`,!e)},{signal:e}),this.#r.addEventListener(`keydown`,e=>{if(e.key===`Escape`){e.preventDefault(),this.#b();return}e.key===`Tab`&&this.#C(e)},{signal:e}),this.#h()}disconnectedCallback(){this.#d=!1,this.#n?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`variant`:this.#g(n);break;case`size`:this.#_(n);break;case`animation`:break;case`heading`:this.#o.textContent=n??``;break;case`open`:{let e=n!==null;e&&!this.#p&&!this.#u&&this.#v(),!e&&this.#p&&!this.#u&&this.#y(),g.play(g.enumPresets.SWOOSHIN);break}}}open(){this.#p||this.#u||this.setAttribute(`open`,``)}close(){!this.#p||this.#u||this.removeAttribute(`open`)}toggle(){this.#p?this.close():this.open()}get isOpen(){return this.#p}get variant(){let e=this.getAttribute(`variant`);return vt(e)?e:`default`}set variant(e){this.setAttribute(`variant`,vt(e)?e:`default`)}get size(){let e=this.getAttribute(`size`);return X(e)?e:`md`}set size(e){this.setAttribute(`size`,X(e)?e:`md`)}get animation(){let e=this.getAttribute(`animation`);return yt(e)?e:`scale`}set animation(e){this.setAttribute(`animation`,yt(e)?e:`scale`)}get heading(){return this.getAttribute(`heading`)??``}set heading(e){this.setAttribute(`heading`,e)}addEventListener(e,t,n){super.addEventListener(e,t,n)}removeEventListener(e,t,n){super.removeEventListener(e,t,n)}get#p(){return this.#r.classList.contains(`is-open`)}#m(){let e=e=>this.#e.querySelector(e);this.#r=e(`.overlay`),this.#i=e(`.panel`),this.#a=e(`.close-btn`),this.#o=e(`#modal-title`),this.#s=e(`.icon-badge`),this.#c=e(`.footer`),this.#l=e(`slot[name="footer"]`)}#h(){this.hasAttribute(`variant`)&&this.#g(this.getAttribute(`variant`)),this.hasAttribute(`size`)&&this.#_(this.getAttribute(`size`)),this.hasAttribute(`heading`)&&(this.#o.textContent=this.getAttribute(`heading`)),this.hasAttribute(`open`)&&this.#v()}#g(e){let t=gt[vt(e)?e:`default`],n=this.#e.host;n.style.setProperty(`--_accent`,t.accent),n.style.setProperty(`--_fg`,t.fg),this.#s.textContent=t.icon??``}#_(e){let t=X(e)?e:`md`;this.#i.style.setProperty(`--_width`,_t[t])}#v(){this.#u=!0,this.#f=document.activeElement,this.#r.classList.add(`is-open`),this.#r.removeAttribute(`aria-hidden`),this.#t.states?.add(`open`),r.emit(`ui:modal:open`,{id:this.id}),requestAnimationFrame(()=>{(this.#T()??this.#a).focus(),this.#u=!1}),this.#S(`ui-modal:open`)}#y(e=!1){this.#u=!0,this.#r.classList.replace(`is-open`,`is-closing`);let t=this.#x(getComputedStyle(this.#r).getPropertyValue(`--_dur`));setTimeout(()=>{this.#r.classList.remove(`is-closing`),this.#r.setAttribute(`aria-hidden`,`true`),this.#t.states?.delete(`open`),this.#u=!1,this.#f?.focus?.(),this.#f=null,r.emit(`ui:modal:close`,{id:this.id}),e&&this.#S(`ui-modal:cancel`),this.#S(`ui-modal:close`)},t)}#b(){!this.#p||this.#u||this.removeAttribute(`open`)}#x(e){let t=e.trim().match(/^(\d+(?:\.\d+)?)(ms|s)?$/);if(!t||t[1]===void 0)return 280;let n=parseFloat(t[1]);return(t[2]??`ms`)===`s`?n*1e3:n}#S(e){let t={modal:this};this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}#C(e){let t=this.#w();if(!t.length){e.preventDefault(),this.#a.focus();return}let n=t[0],r=t[t.length-1],i=this.#e.activeElement instanceof HTMLSlotElement?document.activeElement:this.#e.activeElement;if(!i||!t.includes(i)){e.preventDefault(),n.focus();return}e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}#w(){return[...Array.from(this.#e.querySelectorAll(St)),...Array.from(this.querySelectorAll(St))]}#T(){return this.#w().find(e=>e!==this.#a)??null}};customElements.define(`ui-modal`,Ct);var wt=1500,Tt=2e3,Z={copy:`<ui-icon name="copy"  size="xs"></ui-icon>`,check:`<ui-icon name="check-circle" size="xs"></ui-icon>`,error:`<ui-icon name="alert-circle" size="xs"></ui-icon>`},Et={missing:`variável ausente no template`,used:`variável mapeada`,default:`variável disponível`},Dt=document.createElement(`template`);Dt.innerHTML=`
  <style>
    :host {
      display: inline-flex;
      cursor: pointer;
  ...
  <span part="root" role="button" tabindex="0">
    ...
    <span part="icon" aria-hidden="true">${Z.copy}</span>
  </span>
`;var Ot=class extends HTMLElement{#e;#t=null;#n=null;#r;#i;#a;static observedAttributes=[`state`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(Dt.content.cloneNode(!0)),this.#r=this.#e.querySelector(`[part="root"]`),this.#i=this.#e.querySelector(`[part="icon"]`),this.#a=this.#e.querySelector(`slot`)}connectedCallback(){this.#t=new AbortController;let{signal:e}=this.#t;this.#r.addEventListener(`click`,()=>this.#s(),{signal:e}),this.#r.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.#s())},{signal:e}),this.#a.addEventListener(`slotchange`,()=>this.#l(),{signal:e}),this.#l()}disconnectedCallback(){this.#t?.abort(),this.#t=null,this.#n!==null&&(clearTimeout(this.#n),this.#n=null)}attributeChangedCallback(e,t,n){e===`state`&&t!==n&&this.#l()}get state(){return this.getAttribute(`state`)??`default`}set state(e){this.setAttribute(`state`,e)}#o(){return this.#a.assignedNodes({flatten:!0}).map(e=>e.textContent??``).join(``).trim()}async#s(){let e=this.#o();if(e)try{await navigator.clipboard.writeText(e),this.#c(`copied`),this.dispatchEvent(new CustomEvent(`ui-badge-copied`,{detail:{value:e},bubbles:!0,composed:!0}))}catch(e){this.#c(`error`),console.warn(`[ui-variable-badge] Falha ao copiar para área de transferência:`,e),this.dispatchEvent(new CustomEvent(`ui-badge-copy-error`,{detail:{reason:e},bubbles:!0,composed:!0}))}}#c(e){this.#n!==null&&(clearTimeout(this.#n),this.removeAttribute(`data-copied`),this.removeAttribute(`data-error`));let t=e===`copied`,n=t?wt:Tt,r=t?`data-copied`:`data-error`,i=t?`Copiado!`:`Falha ao copiar`;this.#r.setAttribute(`aria-pressed`,`true`),this.#i.innerHTML=t?Z.check:Z.error,this.setAttribute(r,``),this.#r.setAttribute(`aria-label`,i),this.#n=setTimeout(()=>{this.removeAttribute(r),this.#i.innerHTML=Z.copy,this.#r.setAttribute(`aria-pressed`,`false`),this.#l(),this.#n=null},n)}#l(){let e=this.#o(),t=Et[this.state]??`variável`,n=`${e||`badge`} — ${t}. Clique para copiar.`;this.#r.setAttribute(`aria-label`,n),this.#r.setAttribute(`aria-pressed`,`false`)}};customElements.define(`ui-variable-badge`,Ot);var kt=class extends HTMLElement{dataList=[];currentFileName=``;dataFields=[];labelPlaceholders=[];a4Config={marginMM:10,gapMM:5,columns:2,showCropMarks:!0,bleedMM:2,zoom:.45};isDragging=!1;constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[V])}connectedCallback(){this.render()}refreshLabelPlaceholders(){let e=C.getState().currentLabel;if(!e)return;let t=new Set,n=/\{\{\s*([\w\s."'-]+)(?::([\w,()\s.:-]+))?(?:\|\|([^}]+))?\s*\}\}/g;e.elements.forEach(e=>{if(e.type===u.TEXT&&e.content){let r=e.content,i;for(;(i=n.exec(r))!==null;)t.add(i[1].trim())}}),this.labelPlaceholders=Array.from(t)}render(){if(!this.shadowRoot)return;this.refreshLabelPlaceholders();let e=this.isDragging?`drop-zone dragging`:`drop-zone`;this.shadowRoot.innerHTML=`
      <style>
        :host { display: block; height: 100%; }
      ...
      <div class="flex flex-col gap-3 animate-in fade-in duration-500">
        ...
        <div class="overflow-x-auto border border-border-ui/30 rounded-lg">
          <table class="data-mini-table">
            <thead>
              <tr>${n.map(e=>`<th>${H(e)}</th>`).join(``)}${t.length>4?`<th>...</th>`:``}</tr>
            </thead>
            <tbody>
              ${this.dataList.slice(0,3).map(e=>`
                <tr>
                  ${n.map(t=>`<td>${H(String(e[t]))}</td>`).join(``)}
...
`;function Q(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Mt(e){let t=[],n=0,r=/\[([^\]]+)\]/g,i;for(;(i=r.exec(e))!==null;){i.index>n&&t.push(`<span>${Q(e.slice(n,i.index))}</span>`);let a=i[1],o=U.renderShortcut(a);o?t.push(`<span class="kbd-group" aria-label="Atalho: ${Q(o.description)}">${o.html}</span>`):t.push(`<kbd class="kbd-prism">${Q(a)}</kbd>`),n=r.lastIndex}return n<e.length&&t.push(`<span>${Q(e.slice(n))}</span>`),t.join(``)}function Nt(e){return e.replace(/\[([^\]]+)\]/g,(e,t)=>{let n=U.renderShortcut(t);return n?n.description:t})}function Pt(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}var Ft=class extends HTMLElement{#e;#t=new AbortController;#n=[];#r=0;#i=null;#a=!1;#o=!1;#s=!1;#c=15e3;#l=null;#u=null;#d=null;constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.adoptedStyleSheets=[V,At],this.#e.appendChild(jt.content.cloneNode(!0)),this.#l=this.#e.getElementById(`tip-text`),this.#u=this.#e.getElementById(`sr-text`),this.#d=this.#e.getElementById(`btn-close`)}connectedCallback(){let e=this.#t.signal,t=this.#e.querySelector(`.hud-banner`),n=parseInt(getComputedStyle(this).getPropertyValue(`--hud-tip-interval-ms`).trim(),10);!isNaN(n)&&n>0&&(this.#c=n),t?.addEventListener(`mouseenter`,()=>{this.#a=!0},{signal:e}),t?.addEventListener(`mouseleave`,()=>{this.#a=!1},{signal:e}),this.#d?.addEventListener(`click`,()=>this.#g(),{signal:e}),this.#n.length>0&&(this.#m(!1),this.#f())}disconnectedCallback(){this.#t.abort(),this.#p()}setTips(e){if(!Array.isArray(e)||e.length===0){this.setAttribute(`data-empty`,``);return}this.removeAttribute(`data-empty`),this.#n=Pt(e),this.#r=0,this.#m(!1),this.isConnected&&(this.#p(),this.#f())}pause(){this.#o=!0,this.#p()}resume(){this.#o&&(this.#o=!1,this.#f())}#f(){this.#i===null&&(this.#n.length<=1||(this.#i=window.setInterval(()=>{this.#a||this.#o||this.#s||(this.#r=(this.#r+1)%this.#n.length,this.#m(!0))},this.#c)))}#p(){this.#i!==null&&(clearInterval(this.#i),this.#i=null)}#m(e){let t=this.#l,n=this.#u;if(!t||this.#n.length===0)return;let r=this.#n[this.#r],i=Mt(r),a=Nt(r);if(n&&(n.textContent=`Dica: ${a}`),!e){t.innerHTML=this.#h(i),t.dataset.state=`visible`;return}this.#s=!0,t.dataset.state=`exit-up`,setTimeout(()=>{t.innerHTML=this.#h(i),t.dataset.state=`enter-from-bottom`,t.offsetWidth,t.dataset.state=`visible`,setTimeout(()=>{this.#s=!1},450)},450)}#h(e){return`<span class="tip-prefix" aria-hidden="true">Dica:</span>${e}`}#g(){this.style.opacity=`0`,this.style.transform=`translateY(8px)`,this.style.transition=`opacity 0.3s ease, transform 0.3s ease`,this.dispatchEvent(new CustomEvent(`hud-close`,{detail:{permanent:!1},bubbles:!0,composed:!0})),setTimeout(()=>{this.#p(),this.remove()},300)}};customElements.define(`ui-hud-tips`,Ft),r.on(`notify`,e=>{me.show(e)}),r.on(`ui:open:help`,(e={})=>{localStorage.setItem(`has_seen_guide`,`true`);let t=document.getElementById(`help-center-modal`),n=t?.querySelector(`ui-help-center`);t&&n&&(e.tab&&n.setTab(e.tab),t.setAttribute(`open`,``),g.play(g.enumPresets.OPEN))});var $={id:crypto.randomUUID(),name:`Nova Etiqueta`,config:{...p.CANVAS},elements:[R.create(u.TEXT,{content:`Minha Nova Etiqueta`})],createdAt:Date.now(),updatedAt:Date.now()};document.addEventListener(`DOMContentLoaded`,async()=>{let{isMac:e}=xe(),{preferenceManager:t}=await S(async()=>{let{preferenceManager:e}=await import(`./PreferenceManager-CFY2WSTt.js`);return{preferenceManager:e}},__vite__mapDeps([0,1,2,3]),import.meta.url),n=await t.getPreferences();g.toggle(n.audioEnabled);let i=()=>{g.play(g.enumPresets.TAP)&&(document.removeEventListener(`click`,i),document.removeEventListener(`keydown`,i))};document.addEventListener(`click`,i,{once:!0}),document.addEventListener(`keydown`,i,{once:!0}),r.on(`preferences:change`,e=>{e.audioEnabled!==void 0&&g.toggle(e.audioEnabled)}),await z.init(),ae.init(e);let a=ae.listShortcuts(),{UIKeyboardShortcuts:o}=await S(async()=>{let{UIKeyboardShortcuts:e}=await Promise.resolve().then(()=>Ve);return{UIKeyboardShortcuts:e}},void 0,import.meta.url),s=new o;s.data=a;let c=Object.values(Ge).flatMap(e=>[...e.commands.map(t=>`${e.title}: ${t.key?`[${t.key}] `:``}${t.label} - ${t.desc}`),...e.proTip?[e.proTip.text.replace(/<[^>]*>/g,``)]:[]]);document.querySelector(`ui-hud-tips`)?.setTips([...a.map(e=>`[${e.key||e.sequence}] - ${e.description}`),...Y.proTips.map(e=>e.tip),...c,`Dica: Use [Ctrl+Z] para desfazer ações.`,`Dica: Use as setas do teclado para mover elementos selecionados.`]);let l=localStorage.getItem(`last_active_project`),u=localStorage.getItem(`has_seen_guide`)===`true`,d=!1;if(l){let e=(await z.getTemplates()).find(e=>e.id===l);e&&(C.loadLabel(e),d=!0,r.emit(`notify`,{type:`success`,message:`Sessão anterior restaurada.`,duration:3e3}),g.play(g.enumPresets.SUCCESS))}if(!d&&!u){let e=document.getElementById(`welcome-modal`);e&&e.setAttribute(`open`,``),C.loadLabel($)}else d||(C.loadLabel($),m.info(`Main`,`Standard session initialized: ${$.id}`));r.emit(`preferences:update`,n),r.on(`state:change`,e=>{e.currentLabel?.id&&localStorage.setItem(`last_active_project`,e.currentLabel.id)}),m.info(`Main`,`Application Initialized`),r.emit(`notify`,{type:`info`,message:`Aplicação inicializada com sucesso!`,duration:5e3})});export{S as i,N as n,j as r,L as t};