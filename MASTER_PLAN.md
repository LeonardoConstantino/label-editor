...
| **88** | [Sistema de Logging & Telemetria](./tasks/88_logging_system.md) | 08 | [x] | — | `task/88-logging-system` |
...
| **58** | [Elemento de Código (QR Code / Barcode)](./tasks/58_element_code.md) | 05 | [x] | 41 | `task/58-element-code` |
...
| **84** | [Expansão e Robustez do DataSourceParser](./tasks/84_parser_enhancements.md) | 04 | [x] | 87 | `task/84-parser-pro` |
...
| **72** | [Padronização de Tooltips de Ajuda](./tasks/72_help_tooltips_standardization.md) | 03 | [x] | 46 | `task/72-help-tooltips` |
